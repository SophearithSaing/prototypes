...
class Pt {
  ...
  clamp(t, e) {
    return (
      (this.x = zt(this.x, t.x, e.x)),
      (this.y = zt(this.y, t.y, e.y)),
      this
    );
  }
  clampScalar(t, e) {
...
class I {
  ...
  clamp(t, e) {
    return (
      (this.x = zt(this.x, t.x, e.x)),
      (this.y = zt(this.y, t.y, e.y)),
      (this.z = zt(this.z, t.z, e.z)),
      this
    );
  }
  clampScalar(t, e) {
    return (
      (this.x = zt(this.x, t, e)),
      (this.y = zt(this.y, t, e)),
      (this.z = zt(this.z, t, e)),
      this
    );
  }
  clampLength(t, e) {
...
function Pc() {
  const i = {
        ...
        return (
          this.enabled === !1 ||
            ...
            this.spaces[a].transfer === Yt &&
              ((s.r = _i(s.r)), (s.g = _i(s.g)), (s.b = _i(s.b)))),
          s
        );
      },
      ...
      getTransfer: function (s) {
        return s === Tn ? Ls : this.spaces[s].transfer;
      },
...
class Ic extends qn {
  ...
  copy(t) {
    ...
    for (let e = 0, n = t.textures.length; e < n; e++) {
      ...
      this.textures[e].source = new Ea(s);
    }
    return (
...
class Ei {
    ...
    if (n !== void 0) {
      ...
      if (e === !0 && r !== void 0 && t.isInstancedMesh !== !0)
        for (let a = 0, o = r.count; a < o; a++)
          (t.isMesh === !0
            ? t.getVertexPosition(a, ze)
            : ze.fromBufferAttribute(r, a),
  ...
  intersectsTriangle(t) {
    ...
    (this.getCenter(wi),
      Ji.subVectors(this.max, wi),
      $n.subVectors(t.a, wi),
      Zn.subVectors(t.b, wi),
      Jn.subVectors(t.c, wi),
      _n.subVectors(Zn, $n),
      gn.subVectors(Jn, Zn),
      Ln.subVectors($n, Jn));
    let e = [
    ...
    return !$s(e, $n, Zn, Jn, Ji) ||
      ((e = [1, 0, 0, 0, 1, 0, 0, 0, 1]), !$s(e, $n, Zn, Jn, Ji))
      ? !1
      : (Qi.crossVectors(_n, gn),
        (e = [Qi.x, Qi.y, Qi.z]),
        $s(e, $n, Zn, Jn, Ji));
  }
  clampPoint(t, e) {
    ...
    return (
      this.isEmpty()
        ...
        : (this.getCenter(t.center),
          (t.radius = this.getSize(ze).length() * 0.5)),
      t
    );
  }
  intersect(t) {
...
class Xi {
  ...
  setFromPoints(t, e) {
    const n = this.center;
    e !== void 0 ? n.copy(e) : Fc.setFromPoints(t).getCenter(n);
    let s = 0;
    ...
    return t.isEmpty()
      ...
      : this.isEmpty()
        ...
        : (this.center.equals(t.center) === !0
            ...
            : (Zs.subVectors(t.center, this.center).setLength(t.radius),
              this.expandByPoint(Ri.copy(t.center).add(Zs)),
              this.expandByPoint(Ri.copy(t.center).sub(Zs))),
          this);
  }
  equals(t) {
...
class Os {
  ...
  distanceSqToSegment(t, e, n, s) {
    (Js.copy(t).add(e).multiplyScalar(0.5),
      ts.copy(e).sub(t).normalize(),
      vn.copy(this.origin).sub(Js));
    ...
    return (
      ...
      s && s.copy(Js).addScaledVector(ts, f),
      p
    );
  }
  intersectSphere(t, e) {
  ...
  intersectTriangle(t, e, n, s, r) {
    (Qs.subVectors(e, t), es.subVectors(n, t), tr.crossVectors(Qs, es));
    ...
    const c = o * this.direction.dot(es.crossVectors(vn, es));
    if (c < 0) return null;
    const l = o * this.direction.dot(Qs.cross(vn));
...
class se {
  ...
  extractRotation(t) {
    const e = this.elements,
      n = t.elements,
      s = 1 / Qn.setFromMatrixColumn(t, 0).length(),
      r = 1 / Qn.setFromMatrixColumn(t, 1).length(),
      a = 1 / Qn.setFromMatrixColumn(t, 2).length();
    return (
      (e[0] = n[0] * s),
      (e[1] = n[1] * s),
      (e[2] = n[2] * s),
  ...
  lookAt(t, e, n) {
    ...
    return (
      ...
      Ce.normalize(),
      xn.crossVectors(n, Ce),
      xn.lengthSq() === 0 &&
        (Math.abs(n.z) === 1 ? (Ce.x += 1e-4) : (Ce.z += 1e-4),
        Ce.normalize(),
        xn.crossVectors(n, Ce)),
      xn.normalize(),
      ns.crossVectors(Ce, xn),
      (s[0] = xn.x),
      (s[4] = ns.x),
      (s[8] = Ce.x),
      (s[1] = xn.y),
  ...
  decompose(t, e, n) {
    ...
    const a = Qn.set(s[4], s[5], s[6]).length(),
      o = Qn.set(s[8], s[9], s[10]).length();
  ...
  makePerspective(t, e, n, s, r, a, o = Ze, c = !1) {
    ...
    else if (o === Ze) ((g = -(a + r) / (a - r)), (v = (-2 * a * r) / (a - r)));
    else if (o === Ds) ((g = -a / (a - r)), (v = (-a * r) / (a - r)));
    else
      throw new Error(
  ...
  makeOrthographic(t, e, n, s, r, a, o = Ze, c = !1) {
    ...
    else if (o === Ze) ((g = -2 / (a - r)), (v = -(a + r) / (a - r)));
    else if (o === Ds) ((g = -1 / (a - r)), (v = -r / (a - r)));
    else
      throw new Error(
...
class qe {
  ...
  setFromQuaternion(t, e, n) {
    return (
      ja.makeRotationFromQuaternion(t),
      this.setFromRotationMatrix(ja, e, n)
    );
  }
...
class de extends qn {
  ...
  translateOnAxis(t, e) {
    return (
      $a.copy(t).applyQuaternion(this.quaternion),
  ...
  lookAt(t, e, n) {
    ...
    (this.updateWorldMatrix(!0, !1),
      ...
      this.isCamera || this.isLight
        ? ln.lookAt(Ci, is, this.up)
        : ln.lookAt(is, Ci, this.up),
      this.quaternion.setFromRotationMatrix(ln),
      s &&
        (ln.extractRotation(s.matrixWorld),
  ...
  getWorldQuaternion(t) {
    return (
      this.updateWorldMatrix(!0, !1),
      this.matrixWorld.decompose(Ci, t, Hc),
      t
    );
  }
  getWorldScale(t) {
    return (
      this.updateWorldMatrix(!0, !1),
      this.matrixWorld.decompose(Ci, kc, t),
      t
    );
  }
  getWorldDirection(t) {
...
class Ge {
  ...
  static getBarycoord(t, e, n, s, r) {
    (ke.subVectors(s, e), cn.subVectors(n, e), nr.subVectors(t, e));
    const a = ke.dot(ke),
      o = ke.dot(cn),
      c = ke.dot(nr),
      l = cn.dot(cn),
  ...
  static containsPoint(t, e, n, s) {
    return this.getBarycoord(t, e, n, s, hn) === null
      ? !1
  ...
  static getInterpolatedAttribute(t, e, n, s, r, a) {
    return (
      ...
      or.setScalar(0),
      lr.setScalar(0),
      ar.fromBufferAttribute(t, e),
      or.fromBufferAttribute(t, n),
      lr.fromBufferAttribute(t, s),
      a.setScalar(0),
      a.addScaledVector(ar, r.x),
      a.addScaledVector(or, r.y),
      a.addScaledVector(lr, r.z),
      a
    );
  }
  static isFrontFacing(t, e, n, s) {
    return (ke.subVectors(n, e), cn.subVectors(t, e), ke.cross(cn).dot(s) < 0);
  }
  set(t, e, n) {
  ...
  getArea() {
    return (
      ke.subVectors(this.c, this.b),
      cn.subVectors(this.a, this.b),
      ke.cross(cn).length() * 0.5
    );
  }
  getMidpoint(t) {
    return t
  ...
  getInterpolation(t, e, n, s, r) {
    return Ge.getInterpolation(t, this.a, this.b, this.c, e, n, s, r);
  }
  containsPoint(t) {
  ...
  closestPointToPoint(t, e) {
    const n = this.a,
      ...
      r = this.c;
    let a, o;
    (ni.subVectors(s, n), ii.subVectors(r, n), ir.subVectors(t, n));
    const c = ni.dot(ir),
      l = ii.dot(ir);
    ...
    const f = c * h - u * l;
    if (f <= 0 && c >= 0 && u <= 0)
      return ((a = c / (c - u)), e.copy(n).addScaledVector(ni, a));
    rr.subVectors(t, r);
    const p = ni.dot(rr),
      g = ii.dot(rr);
    ...
    const v = p * l - c * g;
    if (v <= 0 && l >= 0 && g <= 0)
      return ((o = l / (l - g)), e.copy(n).addScaledVector(ii, o));
    const m = u * g - p * h;
    if (m <= 0 && h - u >= 0 && p - g >= 0)
      return (
        eo.subVectors(r, s),
        (o = (h - u) / (h - u + (p - g))),
        e.copy(s).addScaledVector(eo, o)
      );
    const d = 1 / (m + v + f);
    return (
      (a = v * d),
      (o = f * d),
      e.copy(n).addScaledVector(ni, a).addScaledVector(ii, o)
    );
  }
  equals(t) {
...
class Lt {
  ...
  setRGB(t, e, n, s = kt.workingColorSpace) {
    return (
      ...
      (this.g = e),
      (this.b = n),
      kt.colorSpaceToWorking(this, s),
      this
    );
  }
  setHSL(t, e, n, s = kt.workingColorSpace) {
    if (((t = Ac(t, 1)), (e = zt(e, 0, 1)), (n = zt(n, 0, 1)), e === 0))
  ...
  getHex(t = ge) {
    return (
      kt.workingToColorSpace(xe.copy(this), t),
      Math.round(zt(xe.r * 255, 0, 255)) * 65536 +
        Math.round(zt(xe.g * 255, 0, 255)) * 256 +
        Math.round(zt(xe.b * 255, 0, 255))
    );
  }
  getHexString(t = ge) {
  ...
  getHSL(t, e = kt.workingColorSpace) {
    kt.workingToColorSpace(xe.copy(this), e);
    const n = xe.r,
      s = xe.g,
      r = xe.b,
      a = Math.max(n, s, r),
  ...
  lerpHSL(t, e) {
    (this.getHSL(Mn), t.getHSL(ss));
    const n = Xs(Mn.h, ss.h, e),
      s = Xs(Mn.s, ss.s, e),
      r = Xs(Mn.l, ss.l, e);
...
class De extends qn {
    ...
    if (t !== void 0) {
      if ((this.boundingBox.setFromBufferAttribute(t), e))
        for (let n = 0, s = e.length; n < s; n++) {
          const r = e[n];
          (Pe.setFromBufferAttribute(r),
            this.morphTargetsRelative
              ? (_e.addVectors(this.boundingBox.min, Pe.min),
                this.boundingBox.expandByPoint(_e),
                _e.addVectors(this.boundingBox.max, Pe.max),
                this.boundingBox.expandByPoint(_e))
      ...
      if ((Pe.setFromBufferAttribute(t), e))
        for (let r = 0, a = e.length; r < a; r++) {
          ...
          (Pi.setFromBufferAttribute(o),
            this.morphTargetsRelative
              ? (_e.addVectors(Pe.min, Pi.min),
                Pe.expandByPoint(_e),
                _e.addVectors(Pe.max, Pi.max),
                Pe.expandByPoint(_e))
              : (Pe.expandByPoint(Pi.min), Pe.expandByPoint(Pi.max)));
        }
      Pe.getCenter(n);
      let s = 0;
      ...
      if (e)
        for (let r = 0, a = e.length; r < a; r++) {
          ...
          for (let l = 0, u = o.count; l < u; l++)
            (_e.fromBufferAttribute(o, l),
              c && (si.fromBufferAttribute(t, l), _e.add(si)),
              (s = Math.max(s, n.distanceToSquared(_e))));
        }
  ...
  computeTangents() {
    ...
    this.hasAttribute("tangent") === !1 &&
      this.setAttribute("tangent", new Je(new Float32Array(4 * n.count), 4));
  ...
  computeVertexNormals() {
    ...
    if (e !== void 0) {
      ...
      if (n === void 0)
        ((n = new Je(new Float32Array(e.count * 3), 3)),
...
class Le extends de {
    ...
    if (r && o) {
      ...
      for (let c = 0, l = r.length; c < l; c++) {
        const u = o[c],
          h = r[c];
        u !== 0 &&
          (ur.fromBufferAttribute(h, t),
          a ? hs.addScaledVector(ur, u) : hs.addScaledVector(ur.sub(e), u));
      }
      e.add(hs);
    }
    return e;
  ...
  raycast(t, e) {
    ...
    s !== void 0 &&
      ...
      !(
        as.containsPoint(Un.origin) === !1 &&
        (Un.intersectSphere(as, io) === null ||
          Un.origin.distanceToSquared(io) > (t.far - t.near) ** 2)
      ) &&
        (no.copy(r).invert(),
        Un.copy(t.ray).applyMatrix4(no),
...
function qc(i, t, e, n, s, r, a, o) {
  ...
  if (
    (t.side === Ae
      ...
      : (c = n.intersectTriangle(s, r, a, t.side === mn, o)),
    c === null)
  )
    return null;
  ...
  return l < e.near || l > e.far
    ? null
    : { distance: l, point: us.clone(), object: i };
}
function ds(i, t, e, n, s, r, a, o, c, l) {
  (i.getVertexPosition(o, os),
    i.getVertexPosition(c, ls),
    i.getVertexPosition(l, cs));
  const u = qc(i, t, e, n, os, ls, cs, so);
  if (u) {
    const h = new I();
    (Ge.getBarycoord(so, os, ls, cs, h),
      s && (u.uv = Ge.getInterpolatedAttribute(s, o, c, l, h, new Pt())),
      r && (u.uv1 = Ge.getInterpolatedAttribute(r, o, c, l, h, new Pt())),
      a &&
        ((u.normal = Ge.getInterpolatedAttribute(a, o, c, l, h, new I())),
        u.normal.dot(n.direction) > 0 && u.normal.multiplyScalar(-1)));
    const f = { a: o, b: c, c: l, normal: new I(), materialIndex: 0 };
    (Ge.getNormal(os, ls, cs, f.normal), (u.face = f), (u.barycoord = h));
  }
  return u;
}
class qi extends De {
      ...
      for (let ht = 0; ht < N; ht++)
        for (let St = 0; St < C; St++) {
          const Ot = f + St + j * ht,
            ...
            Kt = f + (St + 1) + j * (ht + 1),
            G = f + (St + 1) + j * ht;
          (c.push(Ot, te, G), c.push(te, Kt, G), (z += 6));
        }
      (o.addGroup(p, z, E), (p += z), (f += K));
    }
  }
  copy(t) {
    return (
...
class Rn extends en {
  ...
  copy(t) {
    return (
      ...
      (this.uniformsGroups = Yc(t.uniformsGroups)),
...
class Oe extends pl {
  ...
  getEffectiveFOV() {
    return ca * 2 * Math.atan(Math.tan(Rs * 0.5 * this.fov) / this.zoom);
  }
  getFilmWidth() {
  ...
  getViewBounds(t, e, n) {
    (Sn.set(-1, -1, 0.5).applyMatrix4(this.projectionMatrixInverse),
      e.set(Sn.x, Sn.y).multiplyScalar(-t / Sn.z),
      Sn.set(1, 1, 0.5).applyMatrix4(this.projectionMatrixInverse),
      n.set(Sn.x, Sn.y).multiplyScalar(-t / Sn.z));
  }
  getViewSize(t, e) {
    return (this.getViewBounds(t, ro, ao), e.subVectors(ao, ro));
  }
...
class Zc extends de {
  constructor(t, e, n) {
    ...
    const s = new Oe(ri, ai, t, e);
    ((s.layers = this.layers), this.add(s));
    const r = new Oe(ri, ai, t, e);
    ((r.layers = this.layers), this.add(r));
    const a = new Oe(ri, ai, t, e);
    ((a.layers = this.layers), this.add(a));
    const o = new Oe(ri, ai, t, e);
    ((o.layers = this.layers), this.add(o));
    const c = new Oe(ri, ai, t, e);
    ((c.layers = this.layers), this.add(c));
    const l = new Oe(ri, ai, t, e);
...
class ml extends Ee {
  constructor(t = [], e = vi, n, s, r, a, o, c, l, u) {
...
class Jc extends Xn {
  ...
  fromEquirectangularTexture(t, e) {
    ...
    const a = new Le(s, r),
      o = e.minFilter;
    return (
      e.minFilter === Vn && (e.minFilter = $e),
      new Zc(1, 10, this).update(t, a),
      (e.minFilter = o),
      a.geometry.dispose(),
      a.material.dispose(),
      this
...
class th extends de {
  constructor() {
    (super(),
      ...
      (this.backgroundRotation = new qe()),
      (this.environmentIntensity = 1),
      (this.environmentRotation = new qe()),
...
class yn {
  ...
  setFromCoplanarPoints(t, e, n) {
    const s = fr.subVectors(n, e).cross(eh.subVectors(t, e)).normalize();
  ...
  applyMatrix4(t, e) {
    const n = e || nh.getNormalMatrix(t),
      s = this.coplanarPoint(fr).applyMatrix4(t),
...
class ba {
  ...
  setFromProjectionMatrix(t, e = Ze, n = !1) {
    ...
    if (
      ...
      (s[4].setComponents(l - c, p - f, d - m, L - S).normalize(), e === Ze)
    )
      s[5].setComponents(l + c, p + f, d + m, L + S).normalize();
    else if (e === Ds) s[5].setComponents(c, f, m, S).normalize();
    else
      throw new Error(
  ...
  intersectsSprite(t) {
    ...
    return (
      (In.radius = 0.7071067811865476 + e),
  ...
  intersectsBox(t) {
    ...
    for (let n = 0; n < 6; n++) {
      const s = e[n];
      if (
        ((fs.x = s.normal.x > 0 ? t.max.x : t.min.x),
        (fs.y = s.normal.y > 0 ? t.max.y : t.min.y),
        (fs.z = s.normal.z > 0 ? t.max.z : t.min.z),
        s.distanceToPoint(fs) < 0)
      )
        return !1;
    }
    return !0;
...
class sh extends de {
  ...
  computeLineDistances() {
    ...
    if (t.index === null) {
      ...
      for (let s = 1, r = e.count; s < r; s++)
        (Us.fromBufferAttribute(e, s - 1),
          Is.fromBufferAttribute(e, s),
          (n[s] = n[s - 1]),
          (n[s] += Us.distanceTo(Is)));
  ...
  raycast(t, e) {
    ...
    if (
      ...
      return;
    (oo.copy(s).invert(), Li.copy(t.ray).applyMatrix4(oo));
    ...
    if (u !== null) {
      ...
      for (let v = p, m = g - 1; v < m; v += l) {
        const d = u.getX(v),
          w = u.getX(v + 1),
          T = ms(this, t, Li, c, d, w, v);
        T && e.push(T);
      }
      if (this.isLineLoop) {
        const v = u.getX(g - 1),
          m = u.getX(p),
          d = ms(this, t, Li, c, v, m, g - 1);
        d && e.push(d);
      }
    } else {
      const p = Math.max(0, a.start),
      ...
      for (let v = p, m = g - 1; v < m; v += l) {
        const d = ms(this, t, Li, c, v, v + 1, v);
        d && e.push(d);
      }
      if (this.isLineLoop) {
        const v = ms(this, t, Li, c, g - 1, p, g - 1);
        v && e.push(v);
      }
    }
  }
...
function ms(i, t, e, n, s, r, a) {
  ...
  if (
    (Us.fromBufferAttribute(o, s),
    Is.fromBufferAttribute(o, r),
    e.distanceSqToSegment(Us, Is, pr, lo) > n)
  )
    return;
  ...
  computeLineDistances() {
    ...
    if (t.index === null) {
      ...
      for (let s = 0, r = e.count; s < r; s += 2)
        (co.fromBufferAttribute(e, s),
          ho.fromBufferAttribute(e, s + 1),
          (n[s] = s === 0 ? 0 : n[s - 1]),
          (n[s + 1] = n[s] + co.distanceTo(ho)));
      t.setAttribute("lineDistance", new he(n, 1));
    } else
      console.warn(
...
class mr extends de {
  ...
  raycast(t, e) {
    ...
    if (
      ...
      _s.applyMatrix4(s),
      (_s.radius += r),
      t.ray.intersectsSphere(_s) === !1)
    )
      return;
    (uo.copy(s).invert(), ua.copy(t.ray).applyMatrix4(uo));
    const o = r / ((this.scale.x + this.scale.y + this.scale.z) / 3),
      c = o * o,
      l = n.index,
    ...
    if (l !== null) {
      ...
      for (let g = f, v = p; g < v; g++) {
        const m = l.getX(g);
        (gs.fromBufferAttribute(h, m), fo(gs, m, c, s, t, e, this));
      }
    } else {
      const f = Math.max(0, a.start),
        p = Math.min(h.count, a.start + a.count);
      for (let g = f, v = p; g < v; g++)
        (gs.fromBufferAttribute(h, g), fo(gs, g, c, s, t, e, this));
    }
  }
  updateMorphTargets() {
    const e = this.geometry.morphAttributes,
...
function fo(i, t, e, n, s, r, a) {
  const o = ua.distanceSqToPoint(i);
  if (o < e) {
    const c = new I();
    (ua.closestPointToPoint(i, c), c.applyMatrix4(n));
...
class _l extends Ee {
  constructor(t, e, n = Gn, s, r, a, o = Xe, c = Xe, l, u = Bi, h = 1) {
    if (u !== Bi && u !== zi)
      throw new Error(
  ...
  copy(t) {
    return (
      super.copy(t),
      (this.source = new Ea(Object.assign({}, t.image))),
...
class Aa extends De {
  ...
  static fromJSON(t) {
    return new Aa(t.radius, t.segments, t.thetaStart, t.thetaLength);
  }
}
class Yi extends De {
  ...
  static fromJSON(t) {
    return new Yi(t.width, t.height, t.widthSegments, t.heightSegments);
  }
}
class rh extends en {
  constructor(t) {
...
class Ml extends yi {
  ...
  load(t, e, n, s) {
    ...
    if (un[t] !== void 0) {
      un[t].push({ onLoad: e, onProgress: n, onError: s });
      return;
    }
    ((un[t] = []), un[t].push({ onLoad: e, onProgress: n, onError: s }));
...
class ch extends yi {
  ...
  load(t, e, n, s) {
    ...
    function c() {
      ...
      (oi.delete(this), r.manager.itemEnd(t));
    }
    function l(h) {
      (u(), s && s(h), Ni.remove(`image:${t}`));
      const f = oi.get(this) || [];
      for (let p = 0; p < f.length; p++) {
        const g = f[p];
        g.onError && g.onError(h);
      }
      (oi.delete(this), r.manager.itemError(t), r.manager.itemEnd(t));
    }
    function u() {
...
class dh {
  ...
  updateMatrices(t) {
    ...
    (po.setFromMatrixPosition(t.matrixWorld),
      e.position.copy(po),
      mo.setFromMatrixPosition(t.target.matrixWorld),
      e.lookAt(mo),
      e.updateMatrixWorld(),
      _r.multiplyMatrices(e.projectionMatrix, e.matrixWorldInverse),
...
class _h extends ha {
  constructor(t = 10, e = 10, n = 4473924, s = 8947848) {
    ...
    const u = new De();
    (u.setAttribute("position", new he(c, 3)),
      u.setAttribute("color", new he(l, 3)));
    const h = new Ii({ vertexColors: !0, toneMapped: !1 });
...
#endif`,
  Ph = `vec3 transformed = vec3( position );
#ifdef USE_ALPHAHASH
	vPosition = vec3( position );
#endif`,
  Lh = `vec3 objectNormal = vec3( normal );
#ifdef USE_TANGENT
	vec3 objectTangent = vec3( tangent.xyz );
#endif`,
  Dh = `float G_BlinnPhong_Implicit( ) {
	return 0.25;
}
...
#endif`,
  $h = "gl_FragColor = linearToOutputTexel( gl_FragColor );",
  Zh = `vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
IncidentLight directLight;
  ...
  Cu = `#if defined( USE_POINTS_UV )
	...
	uniform sampler2D alphaMap;
#endif`,
  Pu = `float metalnessFactor = metalness;
#ifdef USE_METALNESSMAP
	vec4 texelMetalness = texture2D( metalnessMap, vMetalnessMapUv );
	metalnessFactor *= texelMetalness.b;
#endif`,
  Lu = `#ifdef USE_METALNESSMAP
	uniform sampler2D metalnessMap;
#endif`,
  Du = `#ifdef USE_INSTANCING_MORPH
...
#endif`,
  Wu = `#ifdef USE_CLEARCOAT_NORMALMAP
...
#endif`,
  $u = `vec4 mvPosition = vec4( transformed, 1.0 );
#ifdef USE_BATCHING
...
#endif`,
  hd = `#ifdef USE_SPECULARMAP
	uniform sampler2D specularMap;
#endif`,
  ud = `#if defined( TONE_MAPPING )
...
#endif`,
  vd = `#if defined( USE_ENVMAP ) || defined( DISTANCE ) || defined ( USE_SHADOWMAP ) || defined ( USE_TRANSMISSION ) || NUM_SPOT_LIGHT_COORDS > 0
...
void main() {
  ...
  je = {
    ...
    depth: {
      uniforms: Se([st.common, st.displacementmap]),
...
function tf(i, t, e, n, s, r, a) {
  ...
  function m(T, S) {
    const L = g(S);
    L && (L.isCubeTexture || L.mapping === Fs)
      ? (u === void 0 &&
          ((u = new Le(
            new qi(1, 1, 1),
            new Rn({
        ...
        u.material.uniforms.backgroundRotation.value.setFromMatrix4(
          Qd.makeRotationFromEuler(Nn),
        ),
        (u.material.toneMapped = kt.getTransfer(L.colorSpace) !== Yt),
      ...
      : L &&
        ...
        (l.material.toneMapped = kt.getTransfer(L.colorSpace) !== Yt),
  ...
  function d(T, S) {
    (T.getRGB(vs, fl(i)), n.buffers.color.setClear(vs.r, vs.g, vs.b, S, a));
  }
  function w() {
        ...
        if (
          (rt === void 0 &&
            (K === "instanceMatrix" &&
              M.instanceMatrix &&
              (rt = M.instanceMatrix),
            K === "instanceColor" && M.instanceColor && (rt = M.instanceColor)),
          rt !== void 0)
        ) {
          ...
          const te = Ot.buffer,
            Kt = Ot.type,
            G = Ot.bytesPerElement,
            at = Kt === i.INT || Kt === i.UNSIGNED_INT || rt.gpuType === ma;
          if (rt.isInterleavedBufferAttribute) {
            ...
            if (nt.isInstancedInterleavedBuffer) {
              for (let Dt = 0; Dt < z.locationSize; Dt++)
                d(z.location + Dt, nt.meshPerAttribute);
              M.isInstancedMesh !== !0 &&
                k._maxInstanceCount === void 0 &&
                (k._maxInstanceCount = nt.meshPerAttribute * nt.count);
            } else
              for (let Dt = 0; Dt < z.locationSize; Dt++) m(z.location + Dt);
...
function af(i) {
  let t = new WeakMap();
  function e(a, o) {
    return (o === Ir ? (a.mapping = vi) : o === Nr && (a.mapping = xi), a);
  }
  function n(a) {
    if (a && a.isTexture) {
      const o = a.mapping;
...
const ui = 4,
  vo = [0.125, 0.215, 0.35, 0.446, 0.526, 0.582],
  Hn = 20,
  gr = new El(),
  xo = new Lt();
let vr = null,
...
class So {
  ...
  fromScene(t, e = 0, n = 0.1, s = 100, r = {}) {
    const { size: a = 256, position: o = of } = r;
    ((vr = this._renderer.getRenderTarget()),
      (xr = this._renderer.getActiveCubeFace()),
      (Mr = this._renderer.getActiveMipmapLevel()),
  ...
  _cleanup(t) {
    (this._renderer.setRenderTarget(vr, xr, Mr),
      (this._renderer.xr.enabled = Sr),
      (t.scissorTest = !1),
      xs(t, 0, 0, t.width, t.height));
  }
  _fromTexture(t, e) {
    (t.mapping === vi || t.mapping === xi
      ? this._setSize(
          t.image.length === 0
            ? 16
  ...
  _allocateTargets() {
    ...
    if (
      ...
      (this._pingPongRenderTarget !== null && this._dispose(),
        (this._pingPongRenderTarget = Eo(t, e, n)));
  ...
  _textureToCubeUV(t, e) {
    ...
    const r = s ? this._cubemapMaterial : this._equirectMaterial,
      a = new Le(this._lodPlanes[0], r),
      o = r.uniforms;
    o.envMap.value = t;
    const c = this._cubeSize;
    (xs(e, 0, 0, 3 * c, 2 * c), n.setRenderTarget(e), n.render(a, gr));
  }
  _applyPMREM(t) {
  ...
  _halfBlur(t, e, n, s, r, a, o) {
    ...
    const u = 3,
      h = new Le(this._lodPlanes[s], l),
      f = l.uniforms,
      p = this._sizeLods[n] - 1,
      g = isFinite(r) ? Math.PI / (2 * p) : (2 * Math.PI) / (2 * Hn - 1),
      v = r / g,
      m = isFinite(r) ? 1 + Math.floor(u * v) : Hn;
    m > Hn &&
      console.warn(
        `sigmaRadians, ${r}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${Hn}`,
      );
    const d = [];
    let w = 0;
    for (let C = 0; C < Hn; ++C) {
    ...
    const S = this._sizeLods[s],
      L = 3 * S * (s > T - ui ? s - T + ui : 0),
      R = 4 * (this._cubeSize - S);
    (xs(e, L, R, 3 * S, 2 * S), c.setRenderTarget(e), c.render(h, gr));
  }
}
function lf(i) {
  const t = [],
    ...
    n = [];
  let s = i;
  const r = i - ui + 1 + vo.length;
  for (let a = 0; a < r; a++) {
    const o = Math.pow(2, s);
    e.push(o);
    let c = 1 / o;
    (a > i - ui ? (c = vo[a - i + ui - 1]) : a === 0 && (c = 0), n.push(c));
    const l = 1 / (o - 2),
      u = -l,
      h = 1 + l,
    ...
    const L = new De();
    (L.setAttribute("position", new Je(w, v)),
      L.setAttribute("uv", new Je(T, m)),
      L.setAttribute("faceIndex", new Je(S, d)),
      t.push(L),
      s > ui && s--);
  }
        ...
        for (let q = 0; q < W.count; q++) {
          ...
          (g === !0 &&
            ...
            m === !0 &&
              ...
              (C[j + K + 9] = s.y),
              (C[j + K + 10] = s.z),
              (C[j + K + 11] = X.itemSize === 4 ? s.w : 1)));
        }
      }
      ((f = { count: h, texture: N, size: new Pt(L, R) }),
        n.set(o, f),
...
function Ti(i, t, e) {
  ...
  const s = t * e;
  let r = Ao[s];
  if ((r === void 0 && ((r = new Float32Array(s)), (Ao[s] = r)), t !== 0)) {
    n.toArray(r, 0);
...
function Bs(i, t) {
  let e = wo[t];
  e === void 0 && ((e = new Int32Array(t)), (wo[t] = e));
...
function Sf(i, t) {
  ...
  if (n === void 0) {
    ...
    if (fe(e, n)) return;
    (Po.set(n), i.uniformMatrix2fv(this.addr, !1, Po), pe(e, n));
  }
}
function Ef(i, t) {
  const e = this.cache,
  ...
  if (n === void 0) {
    ...
    if (fe(e, n)) return;
    (Co.set(n), i.uniformMatrix3fv(this.addr, !1, Co), pe(e, n));
  }
}
function yf(i, t) {
  const e = this.cache,
  ...
  if (n === void 0) {
    ...
    if (fe(e, n)) return;
    (Ro.set(n), i.uniformMatrix4fv(this.addr, !1, Ro), pe(e, n));
  }
}
function Tf(i, t) {
  const e = this.cache;
...
function Uf(i, t, e) {
  const n = this.cache,
    s = e.allocateTextureUnit();
  (n[0] !== s && (i.uniform1i(this.addr, s), (n[0] = s)),
    e.setTexture3D(t || Al, s));
}
function If(i, t, e) {
  const n = this.cache,
    s = e.allocateTextureUnit();
  (n[0] !== s && (i.uniform1i(this.addr, s), (n[0] = s)),
    e.setTextureCube(t || wl, s));
}
function Nf(i, t, e) {
  const n = this.cache,
    s = e.allocateTextureUnit();
  (n[0] !== s && (i.uniform1i(this.addr, s), (n[0] = s)),
    e.setTexture2DArray(t || bl, s));
}
function Ff(i) {
  switch (i) {
    case 5126:
...
function Jf(i, t, e) {
  ...
  for (let a = 0; a !== s; ++a) e.setTexture2D(t[a] || Tl, r[a]);
}
function Qf(i, t, e) {
  const n = this.cache,
    s = t.length,
...
function ep(i, t, e) {
  const n = this.cache,
    ...
    r = Bs(e, s);
  fe(n, r) || (i.uniform1iv(this.addr, r), pe(n, r));
  for (let a = 0; a !== s; ++a) e.setTexture2DArray(t[a] || bl, r[a]);
}
function np(i) {
  switch (i) {
    case 5126:
...
function ap(i, t, e) {
  ...
  for (Er.lastIndex = 0; ;) {
    ...
    if ((c && (o = o | 0), l === void 0 || (l === "[" && a + 2 === s))) {
      Lo(e, l === void 0 ? new ip(o, i, t) : new sp(o, i, t));
      break;
    } else {
      let h = e.map[o];
      (h === void 0 && ((h = new rp(o)), Lo(e, h)), (e = h));
    }
  }
}
class Cs {
...
const Uo = new Nt();
function hp(i) {
  kt._getMatrix(Uo, kt.workingColorSpace, i);
...
const Ms = new I();
function fp() {
  kt.getLuminanceCoefficients(Ms);
  ...
  return (
    i.shadowMapType === jo
      ...
      : i.shadowMapType === Ko
        ...
        : i.shadowMapType === dn && (t = "SHADOWMAP_TYPE_VSM"),
    t
  );
}
function yp(i) {
...
`)),
      (d = [
        ...
        e.toneMapping !== An ? dp("toneMapping", e.toneMapping) : "",
...
` +
  ...
  const T = w + m + a,
    S = w + d + o,
    L = Do(s, s.VERTEX_SHADER, T),
    R = Do(s, s.FRAGMENT_SHADER, S);
  (s.attachShader(v, L),
    s.attachShader(v, R),
...
` +
      ...
      rt &&
        (b.diagnostics = {
          ...
          fragmentShader: { log: K, prefix: d },
        });
    }
    (s.deleteShader(L), s.deleteShader(R), (N = new Cs(s, v)), (E = _p(s, v)));
  }
  let N;
  ...
  return (
    (this.isReady = function () {
      return (M === !1 && (M = s.getProgramParameter(v, op)), M);
    }),
...
function Lp(i, t, e, n, s, r, a) {
  ...
  function m(E, M, b, W, k) {
    const X = W.fog,
      ...
      K = (E.isMeshStandardMaterial ? e : t).get(E.envMap || q),
      z = K && K.mapping === Fs ? K.image.height : null,
      rt = g[E.type];
    E.precision !== null &&
    ...
    if (rt) {
      const Xt = je[rt];
      ((te = Xt.vertexShader), (Kt = Xt.fragmentShader));
    } else
      ((te = E.vertexShader),
        (Kt = E.fragmentShader),
        c.update(E),
    ...
    const nt = i.getRenderTarget(),
      bt = i.state.buffers.depth.getReversed(),
      At = k.isInstancedMesh === !0,
      Dt = k.isBatchedMesh === !0,
      oe = !!E.map,
      Vt = !!E.matcap,
      A = !!K,
      Zt = !!E.aoMap,
      ...
      V = E.sheen > 0,
      $ = E.transmission > 0,
      H = le && !!E.anisotropyMap,
      xt = y && !!E.clearcoatMap,
      et = y && !!E.clearcoatNormalMap,
      _t = y && !!E.clearcoatRoughnessMap,
      gt = F && !!E.iridescenceMap,
      Q = F && !!E.iridescenceThicknessMap,
      ct = V && !!E.sheenColorMap,
      Rt = V && !!E.sheenRoughnessMap,
      vt = !!E.specularMap,
      ot = !!E.specularColorMap,
      It = !!E.specularIntensityMap,
      P = $ && !!E.transmissionMap,
      tt = $ && !!E.thicknessMap,
      it = !!E.gradientMap,
      dt = !!E.alphaMap,
    ...
    const Jt = {
      ...
      precision: p,
      batching: Dt,
      batchingColor: Dt && k._colorsTexture !== null,
      instancing: At,
      instancingColor: At && k.instanceColor !== null,
      instancingMorph: At && k.morphTexture !== null,
      ...
      emissiveMap: ft,
      normalMapObjectSpace: Mt && E.normalMapType === vc,
      normalMapTangentSpace: Mt && E.normalMapType === Sa,
      metalnessMap: Bt,
      roughnessMap: me,
      anisotropy: le,
      anisotropyMap: H,
      ...
      alphaHash: Y,
      combine: E.combine,
      mapUv: oe && v(E.map.channel),
      aoMapUv: Zt && v(E.aoMap.channel),
      lightMapUv: yt && v(E.lightMap.channel),
      ...
      metalnessMapUv: Bt && v(E.metalnessMap.channel),
      ...
      clearcoatRoughnessMapUv: _t && v(E.clearcoatRoughnessMap.channel),
      iridescenceMapUv: gt && v(E.iridescenceMap.channel),
      iridescenceThicknessMapUv: Q && v(E.iridescenceThicknessMap.channel),
      sheenColorMapUv: ct && v(E.sheenColorMap.channel),
      sheenRoughnessMapUv: Rt && v(E.sheenRoughnessMap.channel),
      specularMapUv: vt && v(E.specularMap.channel),
      specularColorMapUv: ot && v(E.specularColorMap.channel),
      specularIntensityMapUv: It && v(E.specularIntensityMap.channel),
      ...
      vertexTangents: !!j.attributes.tangent && (Mt || le),
      vertexColors: E.vertexColors,
      vertexAlphas:
        E.vertexColors === !0 &&
        !!j.attributes.color &&
        j.attributes.color.itemSize === 4,
      pointsUvs: k.isPoints === !0 && !!j.attributes.uv && (oe || dt),
      fog: !!X,
      useFog: E.fog === !0,
      ...
      decodeVideoTexture:
        ...
        kt.getTransfer(E.map.colorSpace) === Yt,
      decodeVideoTextureEmissive:
        ft &&
        E.emissiveMap.isVideoTexture === !0 &&
        kt.getTransfer(E.emissiveMap.colorSpace) === Yt,
      ...
      extensionMultiDraw:
        ((mt && E.extensions.multiDraw === !0) || Dt) &&
    ...
    return (
      (Jt.vertexUv1s = l.has(1)),
      (Jt.vertexUv2s = l.has(2)),
      (Jt.vertexUv3s = l.has(3)),
      l.clear(),
      Jt
    );
  }
  ...
  function L(E, M) {
    ...
    return (b === void 0 && ((b = new wp(i, M, E, r)), u.push(b)), b);
  }
  function R(E) {
    if (--E.usedTimes === 0) {
      const M = u.indexOf(E);
    ...
    get: function (t) {
      ...
      switch (t.type) {
        case "DirectionalLight":
          e = { direction: new I(), color: new Lt() };
          break;
        case "SpotLight":
          e = {
            position: new I(),
          ...
          break;
        case "PointLight":
          e = { position: new I(), color: new Lt(), distance: 0, decay: 0 };
          break;
        case "HemisphereLight":
          e = { direction: new I(), skyColor: new Lt(), groundColor: new Lt() };
          break;
        case "RectAreaLight":
          e = {
            color: new Lt(),
    ...
    for (let E = 0, M = l.length; E < M; E++) {
      ...
      if (b.isAmbientLight) ((u += W.r * k), (h += W.g * k), (f += W.b * k));
        ...
        if ((q.color.copy(b.color).multiplyScalar(b.intensity), b.castShadow)) {
          const K = b.shadow,
            z = e.get(b);
          ((z.shadowIntensity = K.intensity),
            (z.shadowBias = K.bias),
            (z.shadowNormalBias = K.normalBias),
            (z.shadowRadius = K.radius),
            (z.shadowMapSize = K.mapSize),
        ...
        if (
          ...
          ((z.shadowIntensity = K.intensity),
            ...
            (z.shadowRadius = K.radius),
            (z.shadowMapSize = K.mapSize),
            (z.shadowCameraNear = K.camera.near),
            (z.shadowCameraFar = K.camera.far),
            (n.pointShadow[g] = z),
...
function Gp(i, t, e) {
  ...
  this.render = function (R, C, N) {
    ...
    for (let j = 0, q = R.length; j < q; j++) {
      ...
      if (
        ...
        const St = this.type !== dn ? { minFilter: Xe, magFilter: Xe } : {};
        (z.map !== null && z.map.dispose(),
          (z.map = new Xn(s.x, s.y, St)),
      ...
      for (let St = 0; St < ht; St++) {
        const Ot = z.getViewport(St);
        (a.set(r.x * Ot.x, r.y * Ot.y, r.x * Ot.z, r.y * Ot.w),
          W.viewport(a),
          z.updateMatrices(K, St),
          (n = z.getFrustum()),
          S(C, N, z.camera, K, this.type));
      }
      (z.isPointLightShadow !== !0 && this.type === dn && w(z, N),
        (z.needsUpdate = !1));
    }
  ...
  function w(R, C) {
    ...
    (f.defines.VSM_SAMPLES !== R.blurSamples &&
      ...
      (f.needsUpdate = !0),
      (p.needsUpdate = !0)),
      R.mapPass === null && (R.mapPass = new Xn(s.x, s.y)),
...
function Xp(i, t) {
  function e() {
    ...
    return {
      ...
      setClear: function (Z, Y, mt, Ut, Jt) {
        (Jt === !0 && ((Z *= Ut), (Y *= Ut), (mt *= Ut)),
          tt.set(Z, Y, mt, Ut),
          dt.equals(tt) === !1 && (i.clearColor(Z, Y, mt, Ut), dt.copy(tt)));
      },
      reset: function () {
  ...
  function n() {
    ...
    return {
      ...
      setTest: function (Y) {
        Y ? nt(i.DEPTH_TEST) : bt(i.DEPTH_TEST);
      },
      setMask: function (Y) {
  ...
  function s() {
    ...
    return {
      setTest: function (Xt) {
        P || (Xt ? nt(i.STENCIL_TEST) : bt(i.STENCIL_TEST));
      },
      setMask: function (Xt) {
        tt !== Xt && !P && (i.stencilMask(Xt), (tt = Xt));
      },
      setFunc: function (Xt, rn, Ye) {
        (it !== Xt || dt !== rn || Z !== Ye) &&
          (i.stencilFunc(Xt, rn, Ye), (it = Xt), (dt = rn), (Z = Ye));
      },
      setOp: function (Xt, rn, Ye) {
        (Y !== Xt || mt !== rn || Ut !== Ye) &&
          (i.stencilOp(Xt, rn, Ye), (Y = Xt), (mt = rn), (Ut = Ye));
      },
  ...
  z.indexOf("WebGL") !== -1
    ? ((K = parseFloat(/^WebGL (\d)/.exec(z)[1])), (q = K >= 1))
    : z.indexOf("OpenGL ES") !== -1 &&
      ((K = parseFloat(/^OpenGL ES (\d)/.exec(z)[1])), (q = K >= 2));
  let rt = null,
    ht = {};
  const St = i.getParameter(i.SCISSOR_BOX),
    Ot = i.getParameter(i.VIEWPORT),
    te = new ae().fromArray(St),
    Kt = new ae().fromArray(Ot);
  ...
  function Zt(P, tt, it, dt, Z, Y, mt, Ut, Jt, Xt) {
    if (P === bn) {
      v === !0 && (bt(i.BLEND), (v = !1));
      return;
    }
    if ((v === !1 && (nt(i.BLEND), (v = !0)), P !== Gl)) {
      if (P !== m || Xt !== E) {
        if (
          ((d !== zn || S !== zn) &&
            (i.blendEquation(i.FUNC_ADD), (d = zn), (S = zn)),
          Xt)
        )
          switch (P) {
            case pi:
    ...
    ((Z = Z || tt),
      ...
      (mt = mt || dt),
      (tt !== d || Z !== S) &&
        (i.blendEquationSeparate(Vt[tt], Vt[Z]), (d = tt), (S = Z)),
      (it !== w || dt !== T || Y !== L || mt !== R) &&
        ...
        (R = mt)),
      (Ut.equals(C) === !1 || Jt !== N) &&
        (i.blendColor(Ut.r, Ut.g, Ut.b, Jt), C.copy(Ut), (N = Jt)),
      (m = P),
      (E = !1));
  }
  function yt(P, tt) {
    P.side === Ke ? bt(i.CULL_FACE) : nt(i.CULL_FACE);
    let it = P.side === Ae;
    (tt && (it = !it),
      Wt(it),
  ...
  function ft(P, tt, it) {
    P
      ...
      : bt(i.POLYGON_OFFSET_FILL);
  }
  function Bt(P) {
    P ? nt(i.SCISSOR_TEST) : bt(i.SCISSOR_TEST);
  }
  function me(P) {
  ...
  function ct(P) {
    te.equals(P) === !1 && (i.scissor(P.x, P.y, P.z, P.w), te.copy(P));
  }
  function Rt(P) {
  ...
  function It() {
    (i.disable(i.BLEND),
      ...
      (k = null),
      (X = null),
      te.set(0, 0, i.canvas.width, i.canvas.height),
...
function qp(i, t, e, n, s, r, a) {
  ...
  function g(y, _) {
    return p ? new OffscreenCanvas(y, _) : Hi("canvas");
  }
  function v(y, _, F) {
    let V = 1;
    const $ = le(y);
    if (
      (($.width > F || $.height > F) && (V = F / Math.max($.width, $.height)),
      V < 1)
    )
      if (
        ...
        const H = Math.floor(V * $.width),
          xt = Math.floor(V * $.height);
        h === void 0 && (h = g(H, xt));
        const et = _ ? g(H, xt) : h;
        return (
          (et.width = H),
  ...
  function T(y, _, F, V, $ = !1) {
    ...
    if (
      ...
      const xt = $ ? Ls : kt.getTransfer(V);
      (F === i.FLOAT && (H = i.RGBA32F),
        F === i.HALF_FLOAT && (H = i.RGBA16F),
        F === i.UNSIGNED_BYTE && (H = xt === Yt ? i.SRGB8_ALPHA8 : i.RGBA8),
      ...
      y
        ...
        : _ === null || _ === Gn || _ === Oi
          ...
          : _ === fn
            ...
            : _ === Fi && (F = i.DEPTH_COMPONENT16),
      F
    );
  }
  function L(y, _) {
    return m(y) === !0 ||
      (y.isFramebufferTexture && y.minFilter !== Xe && y.minFilter !== $e)
    ...
    if (
      ...
      for (let V = 0; V < 6; V++) {
        if (Array.isArray(_.__webglFramebuffer[V]))
          for (let $ = 0; $ < _.__webglFramebuffer[V].length; $++)
  ...
  const rt = { [Ps]: i.REPEAT, [kn]: i.CLAMP_TO_EDGE, [Fr]: i.MIRRORED_REPEAT },
    ht = {
      [Xe]: i.NEAREST,
  ...
  function Ot(y, _) {
    if (
      ...
      if (
        _.magFilter === Xe ||
        (_.minFilter !== $i && _.minFilter !== Vn) ||
        (_.type === fn && t.has("OES_texture_float_linear") === !1)
      )
        return;
  ...
  function te(y, _) {
    ...
    if (H !== y.__cacheKey) {
      ($[H] === void 0 &&
        (($[H] = { texture: i.createTexture(), usedTimes: 0 }),
        a.memory.textures++,
        (F = !0)),
        $[H].usedTimes++);
      const xt = $[y.__cacheKey];
      (xt !== void 0 &&
        ($[y.__cacheKey].usedTimes--, xt.usedTimes === 0 && E(_)),
        (y.__cacheKey = H),
        (y.__webglTexture = $[H].texture));
    }
    return F;
  }
  function Kt(y, _, F) {
    ...
    if (H.length === 0)
      ...
      for (let Q = 1; Q < H.length; Q++) {
        const ct = H[xt],
          ...
          ot = Kt(Rt.start, _.width, 4),
          It = Kt(ct.start, _.width, 4);
        Rt.start <= vt + 1 &&
        ot === It &&
        Kt(Rt.start + Rt.count - 1, _.width, 4) === ot
      ...
      for (let Q = 0, ct = H.length; Q < ct; Q++) {
        const Rt = H[Q],
          vt = Math.floor(Rt.start / 4),
          ot = Math.ceil(Rt.count / 4),
          It = vt % _.width,
        ...
        (i.pixelStorei(i.UNPACK_SKIP_PIXELS, It),
          ...
          e.texSubImage2D(i.TEXTURE_2D, 0, It, P, tt, it, F, V, _.data));
      }
      (y.clearUpdateRanges(),
  ...
  function at(y, _, F) {
    ...
    const xt = n.get(H);
    if (H.version !== xt.__version || $ === !0) {
      e.activeTexture(i.TEXTURE0 + F);
      const et = kt.getPrimaries(kt.workingColorSpace),
        _t = _.colorSpace === Tn ? null : kt.getPrimaries(_.colorSpace),
        gt =
          _.colorSpace === Tn || et === _t ? i.NONE : i.BROWSER_DEFAULT_WEBGL;
      ...
      const ct = r.convert(_.format, _.colorSpace),
        Rt = r.convert(_.type);
      let vt = T(_.internalFormat, ct, Rt, _.colorSpace, _.isVideoTexture);
      Ot(V, _);
      let ot;
      const It = _.mipmaps,
        P = _.isVideoTexture !== !0,
        tt = xt.__version === void 0 || $ === !0,
        it = H.dataReady,
        dt = L(_, Q);
      if (_.isDepthTexture)
        ((vt = S(_.format === zi, _.type)),
          tt &&
            (P
        ...
        if (It.length > 0) {
          P &&
            tt &&
            e.texStorage2D(i.TEXTURE_2D, dt, vt, It[0].width, It[0].height);
          for (let Z = 0, Y = It.length; Z < Y; Z++)
            ((ot = It[Z]),
              P
                ? it &&
                  e.texSubImage2D(
        ...
        if (_.isCompressedArrayTexture) {
          ...
          for (let Z = 0, Y = It.length; Z < Y; Z++)
            if (((ot = It[Z]), _.format !== We))
              if (ct !== null)
                if (P) {
                  if (it)
                    if (_.layerUpdates.size > 0) {
                      const mt = go(ot.width, ot.height, _.format, _.type);
        ...
        if (P) {
          if (
            ...
            if (_.layerUpdates.size > 0) {
              const Z = go(Q.width, Q.height, _.format, _.type);
        ...
        if (tt)
          if (P) e.texStorage2D(i.TEXTURE_2D, dt, vt, Q.width, Q.height);
            ...
            for (let mt = 0; mt < dt; mt++)
              (e.texImage2D(i.TEXTURE_2D, mt, vt, Z, Y, 0, ct, Rt, null),
                (Z >>= 1),
                (Y >>= 1));
          }
      } else if (It.length > 0) {
        ...
        for (let Z = 0, Y = It.length; Z < Y; Z++)
          ((ot = It[Z]),
            P
              ? it && e.texSubImage2D(i.TEXTURE_2D, Z, 0, 0, ct, Rt, ot)
              : e.texImage2D(i.TEXTURE_2D, Z, vt, ct, Rt, ot));
        _.generateMipmaps = !1;
      } else if (P) {
        if (tt) {
          const Z = le(Q);
        ...
        it && e.texSubImage2D(i.TEXTURE_2D, 0, 0, 0, ct, Rt, Q);
      } else e.texImage2D(i.TEXTURE_2D, 0, vt, ct, Rt, Q);
  ...
  function nt(y, _, F) {
    ...
    const H = n.get($);
    if ($.version !== H.__version || V === !0) {
      e.activeTexture(i.TEXTURE0 + F);
      const xt = kt.getPrimaries(kt.workingColorSpace),
        et = _.colorSpace === Tn ? null : kt.getPrimaries(_.colorSpace),
        _t =
          _.colorSpace === Tn || xt === et ? i.NONE : i.BROWSER_DEFAULT_WEBGL;
      (i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL, _.flipY),
        i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL, _.premultiplyAlpha),
        i.pixelStorei(i.UNPACK_ALIGNMENT, _.unpackAlignment),
        i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL, _t));
      const gt = _.isCompressedTexture || _.image[0].isCompressedTexture,
      ...
      const Rt = ct[0],
        ...
        ot = r.convert(_.type),
        It = T(_.internalFormat, vt, ot, _.colorSpace),
        P = _.isVideoTexture !== !0,
      ...
      if (gt) {
        P &&
          tt &&
          e.texStorage2D(i.TEXTURE_CUBE_MAP, dt, It, Rt.width, Rt.height);
        for (let Y = 0; Y < 6; Y++) {
          Z = ct[Y].mipmaps;
        ...
        if (((Z = _.mipmaps), P && tt)) {
          Z.length > 0 && dt++;
          const Y = le(ct[0]);
          e.texStorage2D(i.TEXTURE_CUBE_MAP, dt, It, Y.width, Y.height);
        }
        for (let Y = 0; Y < 6; Y++)
          if (Q) {
            P
  ...
  function bt(y, _, F, V, $, H) {
    const xt = r.convert(F.format, F.colorSpace),
      et = r.convert(F.type),
      _t = T(F.internalFormat, xt, et, F.colorSpace),
      gt = n.get(_),
      Q = n.get(F);
    if (((Q.__renderTarget = _), !gt.__hasExternalTextures)) {
      const ct = Math.max(1, _.width >> H),
        Rt = Math.max(1, _.height >> H);
      $ === i.TEXTURE_3D || $ === i.TEXTURE_2D_ARRAY
        ? e.texImage3D($, H, _t, ct, Rt, _.depth, 0, xt, et, null)
        : e.texImage2D($, H, _t, ct, Rt, 0, xt, et, null);
    }
    (e.bindFramebuffer(i.FRAMEBUFFER, y),
      ft(_)
        ...
        : ($ === i.TEXTURE_2D ||
          ...
          i.framebufferTexture2D(i.FRAMEBUFFER, V, $, Q.__webglTexture, H),
      e.bindFramebuffer(i.FRAMEBUFFER, null));
  }
  function At(y, _, F) {
    if ((i.bindRenderbuffer(i.RENDERBUFFER, y), _.depthBuffer)) {
      const V = _.depthTexture,
        $ = V && V.isDepthTexture ? V.type : null,
        H = S(_.stencilBuffer, $),
      ...
      for (let $ = 0; $ < V.length; $++) {
        const H = V[$],
          ...
          et = r.convert(H.type),
          _t = T(H.internalFormat, xt, et, H.colorSpace),
          gt = ee(_);
        F && ft(_) === !1
          ? i.renderbufferStorageMultisample(
              i.RENDERBUFFER,
          ...
          : ft(_)
            ...
            : i.renderbufferStorage(i.RENDERBUFFER, _t, _.width, _.height);
      }
    }
  ...
  function Dt(y, _) {
    ...
    ((V.__renderTarget = _),
      ...
      j(_.depthTexture, 0));
    const $ = V.__webglTexture,
      H = ee(_);
    if (_.depthTexture.format === Bi)
      ft(_)
        ? o.framebufferTexture2DMultisampleEXT(
            i.FRAMEBUFFER,
            i.DEPTH_ATTACHMENT,
    ...
    else if (_.depthTexture.format === zi)
      ft(_)
        ? o.framebufferTexture2DMultisampleEXT(
            i.FRAMEBUFFER,
  ...
  function oe(y) {
      ...
      if ((_.__depthDisposeCallback && _.__depthDisposeCallback(), V)) {
        const $ = () => {
          (delete _.__boundDepthTexture,
            ...
            V.removeEventListener("dispose", $));
        };
        (V.addEventListener("dispose", $), (_.__depthDisposeCallback = $));
      }
    ...
    if (y.depthTexture && !_.__autoAllocateDepthBuffer) {
      ...
      V && V.length > 0
        ? Dt(_.__webglFramebuffer[0], y)
        : Dt(_.__webglFramebuffer, y);
    } else if (F) {
      ...
      for (let V = 0; V < 6; V++)
        if (
          ...
          (i.bindRenderbuffer(i.RENDERBUFFER, H),
            i.framebufferRenderbuffer(i.FRAMEBUFFER, $, i.RENDERBUFFER, H));
        }
    } else {
      const V = y.texture.mipmaps;
      if (
    ...
    if (
      ...
      for (let et = 0; et < 6; et++)
        if (_.mipmaps && _.mipmaps.length > 0) {
          ...
          for (let _t = 0; _t < _.mipmaps.length; _t++)
            F.__webglFramebuffer[et][_t] = i.createFramebuffer();
      ...
      if (xt)
        for (let et = 0, _t = $.length; et < _t; et++) {
          const gt = n.get($[et]);
          gt.__webglTexture === void 0 &&
            ((gt.__webglTexture = i.createTexture()), a.memory.textures++);
        }
      if (y.samples > 0 && ft(y) === !1) {
        ...
        for (let et = 0; et < $.length; et++) {
          ...
          const gt = r.convert(_t.format, _t.colorSpace),
            Q = r.convert(_t.type),
            ct = T(
              _t.internalFormat,
              gt,
        ...
        (i.bindRenderbuffer(i.RENDERBUFFER, null),
          y.depthBuffer &&
            ...
            At(F.__webglDepthRenderbuffer, y, !0)),
          e.bindFramebuffer(i.FRAMEBUFFER, null));
      }
    }
    if (H) {
      ...
      for (let et = 0, _t = $.length; et < _t; et++) {
        ...
        ((y.isWebGL3DRenderTarget || y.isWebGLArrayRenderTarget) &&
          ...
          Ot(ct, gt),
          bt(F.__webglFramebuffer, y, gt, i.COLOR_ATTACHMENT0 + et, ct, 0),
          m(gt) && d(ct));
      }
      e.unbindTexture();
    } else {
      ...
      if (
        ...
        for (let _t = 0; _t < _.mipmaps.length; _t++)
          bt(F.__webglFramebuffer[_t], y, _, i.COLOR_ATTACHMENT0, et, _t);
      else bt(F.__webglFramebuffer, y, _, i.COLOR_ATTACHMENT0, et, 0);
        ...
        for (let gt = 0; gt < _.length; gt++) {
          if (
            ...
            i.framebufferRenderbuffer(
              ...
              i.COLOR_ATTACHMENT0,
              i.RENDERBUFFER,
              xt.__webglColorRenderbuffer[gt],
            );
            const Q = n.get(_[gt]).__webglTexture;
            i.framebufferTexture2D(
              i.DRAW_FRAMEBUFFER,
              i.COLOR_ATTACHMENT0,
              i.TEXTURE_2D,
          ...
          (i.blitFramebuffer(0, 0, F, V, 0, 0, F, V, $, i.NEAREST),
            c === !0 &&
              ((yt.length = 0),
              (Wt.length = 0),
              yt.push(i.COLOR_ATTACHMENT0 + gt),
              y.depthBuffer &&
                y.resolveDepthBuffer === !1 &&
                (yt.push(H),
                Wt.push(H),
                i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER, Wt)),
  ...
  ((this.allocateTextureUnit = k),
    ...
    (this.updateRenderTargetMipmap = Zt),
  ...
  function e(n, s = Tn) {
    ...
    if (n === kr || n === Vr || n === Gr)
      if (((r = t.get("WEBGL_compressed_texture_etc")), r !== null)) {
        if (n === kr || n === Vr)
          return a === Yt ? r.COMPRESSED_SRGB8_ETC2 : r.COMPRESSED_RGB8_ETC2;
        if (n === Gr)
          return a === Yt
...
class $p {
  ...
  getMesh(t) {
    if (this.texture !== null && this.mesh === null) {
      ...
      this.mesh = new Le(new Yi(20, 20), n);
    }
    return this.mesh;
  }
  reset() {
...
class Zp extends qn {
  constructor(t, e) {
        ...
        if (((s = G), s !== null)) {
          if (
            ...
            let nt = null,
              ...
              At = null;
            d.depth &&
              ((At = d.stencil ? e.DEPTH24_STENCIL8 : e.DEPTH_COMPONENT24),
              (nt = d.stencil ? zi : Bi),
              (bt = d.stencil ? Oi : Gn));
            const Dt = {
              colorFormat: e.RGBA8,
            ...
            ((p = new XRWebGLLayer(s, e, nt)),
              ...
              (T = new Xn(p.framebufferWidth, p.framebufferHeight, {
                format: We,
                type: tn,
                colorSpace: t.outputColorSpace,
                stencilBuffer: d.stencil,
    ...
    function q(G) {
      for (let at = 0; at < G.removed.length; at++) {
        const nt = G.removed[at],
          bt = L.indexOf(nt);
        bt >= 0 && ((L[bt] = null), S[bt].disconnect(nt));
      }
    ...
    const K = new I(),
      z = new I();
    function rt(G, at, nt) {
      (K.setFromMatrixPosition(at.matrixWorld),
        z.setFromMatrixPosition(nt.matrixWorld));
      const bt = K.distanceTo(z),
        At = at.projectionMatrix.elements,
        Dt = nt.projectionMatrix.elements,
        oe = At[14] / (At[10] - 1),
        Vt = At[14] / (At[10] + 1),
        A = (At[9] + 1) / At[5],
        Zt = (At[9] - 1) / At[5],
      ...
      if (
        ...
        const me = oe + ft,
          ...
          F = ((A * Vt) / le) * me,
          V = ((Zt * Vt) / le) * me;
        (G.projectionMatrix.makePerspective(y, _, F, V, me, le),
    ...
    this.updateCamera = function (G) {
      ...
      const bt = G.parent,
        At = b.cameras;
      ht(b, bt);
      for (let Dt = 0; Dt < At.length; Dt++) ht(At[Dt], bt);
      (At.length === 2
        ? rt(b, N, E)
    ...
    function St(G, at, nt) {
      (nt === null
        ...
        G.isPerspectiveCamera &&
          ((G.fov = ca * 2 * Math.atan(1 / G.projectionMatrix.elements[5])),
          (G.zoom = 1)));
    }
    ...
    function te(G, at) {
      if (((u = at.getViewerPose(l || a)), (g = at), u !== null)) {
        ...
        p !== null &&
          ...
          t.setRenderTarget(T));
        let bt = !1;
        nt.length !== b.cameras.length && ((b.cameras.length = 0), (bt = !0));
        for (let Vt = 0; Vt < nt.length; Vt++) {
          const A = nt[Vt];
          let Zt = null;
          if (p !== null) Zt = p.getViewport(A);
          else {
            const Wt = h.getViewSubImage(f, A);
            ((Zt = Wt.viewport),
              Vt === 0 &&
                (t.setRenderTargetTextures(
                  T,
                  Wt.colorTexture,
                  Wt.depthStencilTexture,
                ),
                t.setRenderTarget(T)));
          }
          let yt = M[Vt];
          (yt === void 0 &&
            ...
            (yt.viewport = new ae()),
            (M[Vt] = yt)),
            yt.matrix.fromArray(A.transform.matrix),
            yt.matrix.decompose(yt.position, yt.quaternion, yt.scale),
            yt.projectionMatrix.fromArray(A.projectionMatrix),
            yt.projectionMatrixInverse.copy(yt.projectionMatrix).invert(),
            yt.viewport.set(Zt.x, Zt.y, Zt.width, Zt.height),
            Vt === 0 &&
              (b.matrix.copy(yt.matrix),
              b.matrix.decompose(b.position, b.quaternion, b.scale)),
            bt === !0 && b.cameras.push(yt));
        }
        const At = s.enabledFeatures;
        if (
          At &&
          At.includes("depth-sensing") &&
          s.depthUsage == "gpu-optimized" &&
          h
        ) {
          const Vt = h.getDepthInformation(nt[0]);
          Vt && Vt.isValid && Vt.texture && v.init(Vt, s.renderState);
        }
        if (At && At.includes("camera-access") && (t.state.unbindTexture(), h))
          for (let Vt = 0; Vt < nt.length; Vt++) {
            const A = nt[Vt].camera;
            if (A) {
              let Zt = m[A];
              Zt || ((Zt = new Rl()), (m[A] = Zt));
              const yt = h.getCameraImage(A);
              Zt.sourceTexture = yt;
            }
          }
      }
      for (let nt = 0; nt < S.length; nt++) {
        const bt = L[nt],
          At = S[nt];
        bt !== null && At !== void 0 && At.update(bt, at, l || a);
      }
      (Ot && Ot(G, at),
        at.detectedPlanes &&
...
function Qp(i, t) {
  ...
  function n(m, d) {
    (d.color.getRGB(m.fogColor.value, fl(i)),
      d.isFog
  ...
  function r(m, d) {
    ...
    (T &&
      ...
      T.isCubeTexture &&
        ...
        ((Fn.y *= -1), (Fn.z *= -1)),
      m.envMapRotation.value.setFromMatrix4(Jp.makeRotationFromEuler(Fn)),
      (m.flipEnvMap.value =
    ...
    ((m.ior.value = d.ior),
      ...
      d.clearcoat > 0 &&
        ...
        d.clearcoatNormalMap &&
          ...
          d.side === Ae && m.clearcoatNormalScale.value.negate())),
            ...
            typeof q == "number" || typeof q == "boolean"
              ...
              : q.isMatrix3
                ...
                : (q.toArray(b.__data, X),
                  (X += K.storage / Float32Array.BYTES_PER_ELEMENT));
          }
...
class em {
  constructor(t = {}) {
    ...
    try {
      ...
      if (
        ("setAttribute" in e &&
          e.setAttribute("data-engine", `three.js r${fa}`),
    ...
    function P() {
      ((yt = new uf(A)),
        ...
        (Wt = new sf(A, yt, t, vt)),
        (Mt = new Xp(A, yt)),
        Wt.reversedDepthBuffer && f && Mt.buffers.depth.setReversed(!0),
        (ee = new pf(A)),
        (ft = new Dp()),
        (Bt = new qp(A, yt, Mt, ft, Wt, vt, ee)),
        (me = new af(S)),
        (le = new hf(S)),
        (y = new xh(A)),
        (ot = new ef(A, y)),
        ...
        (Q = new mf(A, Wt, Bt)),
        (et = new rf(ft)),
        (V = new Lp(S, me, le, yt, Wt, ot, et)),
        ($ = new Qp(S, ft)),
        (H = new Ip()),
        (xt = new Hp(yt)),
        (gt = new tf(S, me, le, Mt, F, p, c)),
        (_t = new Gp(S, F, Wt)),
        (It = new tm(A, ee, Wt, Mt)),
        (ct = new nf(A, yt, ee)),
        (Rt = new ff(A, yt, ee)),
    ...
    ((this.xr = tt),
      ...
      (this.forceContextLoss = function () {
        const x = yt.get("WEBGL_lose_context");
        x && x.loseContext();
      }),
      ...
      (this.setPixelRatio = function (x) {
        x !== void 0 && ((z = x), this.setSize(q, K, !1));
      }),
      ...
      (this.setScissor = function (x, D, O, B) {
        (x.isVector4 ? Ot.set(x.x, x.y, x.z, x.w) : Ot.set(x, D, O, B),
          Mt.scissor(W.copy(Ot).multiplyScalar(z).round()));
      }),
      (this.getScissorTest = function () {
        return te;
      }),
      (this.setScissorTest = function (x) {
        Mt.setScissorTest((te = x));
      }),
      ...
      (this.getClearColor = function (x) {
        return x.copy(gt.getClearColor());
      }),
      (this.setClearColor = function () {
        gt.setClearColor(...arguments);
      }),
      (this.getClearAlpha = function () {
        return gt.getClearAlpha();
      }),
      (this.setClearAlpha = function () {
        gt.setClearAlpha(...arguments);
      }),
      ...
      (this.dispose = function () {
        (e.removeEventListener("webglcontextlost", it, !1),
          ...
          V.dispose(),
          tt.dispose(),
          tt.removeEventListener("sessionstart", Ye),
          tt.removeEventListener("sessionend", La),
          Cn.stop());
      }));
    function it(x) {
      (x.preventDefault(),
    ...
    this.renderBufferDirect = function (x, D, O, B, U, J) {
      D === null && (D = Dt);
      const lt = U.isMesh && U.matrixWorld.determinant() < 0,
        pt = Nl(x, D, O, B, U);
      Mt.setMaterial(B, lt);
      let ut = O.index,
        wt = 1;
      ...
      let Ht = Ct.start * wt,
        qt = (Ct.start + Ct.count) * wt;
      (J !== null &&
        ((Ht = Math.max(Ht, J.start * wt)),
        (qt = Math.min(qt, (J.start + J.count) * wt))),
        ut !== null
          ? ((Ht = Math.max(Ht, 0)), (qt = Math.min(qt, ut.count)))
          : Et != null &&
            ((Ht = Math.max(Ht, 0)), (qt = Math.min(qt, Et.count))));
      const re = qt - Ht;
      if (re < 0 || re === 1 / 0) return;
      ot.setup(U, B, pt, O, ut);
      let Qt,
        $t = ct;
      if (
        (ut !== null && ((Qt = y.get(ut)), ($t = Rt), $t.setIndex(Qt)),
        U.isMesh)
      )
        B.wireframe === !0
          ? (Mt.setLineWidth(B.wireframeLinewidth * Vt()), $t.setMode(A.LINES))
          : $t.setMode(A.TRIANGLES);
      else if (U.isLine) {
        let Tt = B.linewidth;
        (Tt === void 0 && (Tt = 1),
          Mt.setLineWidth(Tt * Vt()),
          U.isLineSegments
            ? $t.setMode(A.LINES)
            : U.isLineLoop
              ? $t.setMode(A.LINE_LOOP)
              : $t.setMode(A.LINE_STRIP));
      } else
        U.isPoints
          ? $t.setMode(A.POINTS)
          : U.isSprite && $t.setMode(A.TRIANGLES);
      if (U.isBatchedMesh)
        if (U._multiDrawInstances !== null)
          ...
          const Tt = U._multiDrawStarts,
            ne = U._multiDrawCounts,
            Gt = U._multiDrawCount,
            we = ut ? y.get(ut).bytesPerElement : 1,
            Yn = ft.get(B).currentProgram.getUniforms();
          for (let Re = 0; Re < Gt; Re++)
            (Yn.setValue(A, "_gl_DrawID", Re), $t.render(Tt[Re] / we, ne[Re]));
        }
      else if (U.isInstancedMesh) $t.renderInstances(Ht, re, U.count);
      else if (O.isInstancedBufferGeometry) {
        const Tt = O._maxInstanceCount !== void 0 ? O._maxInstanceCount : 1 / 0,
          ne = Math.min(O.instanceCount, Tt);
        $t.renderInstances(Ht, re, ne);
      } else $t.render(Ht, re);
    };
    function Jt(x, D, O) {
      x.transparent === !0 && x.side === Ke && x.forceSinglePass === !1
        ? ((x.side = Ae),
          (x.needsUpdate = !0),
          Ki(x, D, O),
          (x.side = mn),
    ...
    const Cn = new yl();
    (Cn.setAnimationLoop(rn),
      typeof self < "u" && Cn.setContext(self),
      (this.setAnimationLoop = function (x) {
        ((Xt = x), tt.setAnimationLoop(x), x === null ? Cn.stop() : Cn.start());
      }),
      tt.addEventListener("sessionstart", Ye),
      tt.addEventListener("sessionend", La),
      (this.render = function (x, D) {
        ...
        if (
          ...
          Kt.setFromProjectionMatrix(nt, Ze, D.reversedDepth),
          ...
          J !== null && Vs(J, D, -1 / 0, S.sortObjects);
        }
        (Vs(x, D, 0, S.sortObjects),
          m.finish(),
        ...
        if ((d.setupLights(), D.isArrayCamera)) {
          ...
          for (let lt = 0, pt = J.length; lt < pt; lt++) {
            const ut = J[lt];
            Da(m, x, ut, ut.viewport);
          }
        } else
          (U.length > 0 && Ua(B, U, x, D), oe && gt.render(x), Da(m, x, D));
        (N !== null &&
          C === 0 &&
          (Bt.updateMultisampleRenderTarget(N), Bt.updateRenderTargetMipmap(N)),
      ...
      if (x.layers.test(D.layers)) {
        if (x.isGroup) O = x.renderOrder;
          ...
          if (!x.frustumCulled || Kt.intersectsSprite(x)) {
            B && At.setFromMatrixPosition(x.matrixWorld).applyMatrix4(nt);
            const lt = F.update(x),
              pt = x.material;
            pt.visible && m.push(x, lt, pt, O, At.z, null);
          }
        } else if (
            ...
            (B &&
              (x.boundingSphere !== void 0
                ...
                : (lt.boundingSphere === null && lt.computeBoundingSphere(),
                  At.copy(lt.boundingSphere.center)),
              At.applyMatrix4(x.matrixWorld).applyMatrix4(nt)),
            Array.isArray(pt))
          ) {
            const ut = lt.groups;
            for (let wt = 0, Ct = ut.length; wt < Ct; wt++) {
              const Et = ut[wt],
                Ht = pt[Et.materialIndex];
              Ht && Ht.visible && m.push(x, lt, Ht, O, At.z, Et);
            }
          } else pt.visible && m.push(x, lt, pt, O, At.z, null);
        }
      }
      const J = x.children;
      for (let lt = 0, pt = J.length; lt < pt; lt++) Vs(J[lt], D, O, B);
    }
    function Da(x, D, O, B) {
      const U = x.opaque,
        J = x.transmissive,
    ...
    function Ua(x, D, O, B) {
      ...
      d.state.transmissionRenderTarget[B.id] === void 0 &&
        (d.state.transmissionRenderTarget[B.id] = new Xn(1, 1, {
          generateMipmaps: !0,
          type:
      ...
      if (
        ...
        ji(x, O, B),
        Bt.updateMultisampleRenderTarget(J),
        Bt.updateRenderTargetMipmap(J),
        yt.has("WEBGL_multisampled_render_to_texture") === !1)
      ) {
        let Ht = !1;
        for (let qt = 0, re = D.length; qt < re; qt++) {
          const Qt = D[qt],
            $t = Qt.object,
            Tt = Qt.geometry,
            ne = Qt.material,
            Gt = Qt.group;
          if (ne.side === Ke && $t.layers.test(B.layers)) {
            const we = ne.side;
            ((ne.side = Ae),
              (ne.needsUpdate = !0),
              Ia($t, O, B, Tt, ne, Gt),
        ...
        Ht === !0 &&
          (Bt.updateMultisampleRenderTarget(J), Bt.updateRenderTargetMipmap(J));
      }
      (S.setRenderTarget(pt, ut, wt),
        S.setClearColor(X, j),
    ...
    function ji(x, D, O) {
      ...
      for (let U = 0, J = x.length; U < J; U++) {
        ...
        (Ct.allowOverride === !0 && B !== null && (Ct = B),
          pt.layers.test(O.layers) && Ia(pt, D, O, ut, Ct, wt));
      }
    }
    function Ia(x, D, O, B, U, J) {
      (x.onBeforeRender(S, D, O, B, U, J),
        x.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse, x.matrixWorld),
        x.normalMatrix.getNormalMatrix(x.modelViewMatrix),
        U.onBeforeRender(S, D, O, B, x, J),
        U.transparent === !0 && U.side === Ke && U.forceSinglePass === !1
          ? ((U.side = Ae),
            (U.needsUpdate = !0),
            S.renderBufferDirect(O, D, B, U, x, J),
            (U.side = mn),
            (U.needsUpdate = !0),
            S.renderBufferDirect(O, D, B, U, x, J),
            (U.side = Ke))
          : S.renderBufferDirect(O, D, B, U, x, J),
        x.onAfterRender(S, D, O, B, U, J));
    }
    function Ki(x, D, O) {
      D.isScene !== !0 && (D = Dt);
      const B = ft.get(x),
      ...
      return (
        ...
        B.needsLights &&
          ((Et.ambientLightColor.value = U.state.ambient),
          (Et.lightProbe.value = U.state.probe),
          (Et.directionalLights.value = U.state.directional),
          (Et.directionalLightShadows.value = U.state.directionalShadow),
          (Et.spotLights.value = U.state.spot),
          (Et.spotLightShadows.value = U.state.spotShadow),
          (Et.rectAreaLights.value = U.state.rectArea),
          (Et.ltc_1.value = U.state.rectAreaLTC1),
          (Et.ltc_2.value = U.state.rectAreaLTC2),
          (Et.pointLights.value = U.state.point),
          (Et.pointLightShadows.value = U.state.pointShadow),
          (Et.hemisphereLights.value = U.state.hemi),
          (Et.directionalShadowMap.value = U.state.directionalShadowMap),
          (Et.directionalShadowMatrix.value = U.state.directionalShadowMatrix),
          (Et.spotShadowMap.value = U.state.spotShadowMap),
          (Et.spotLightMatrix.value = U.state.spotLightMatrix),
          (Et.spotLightMap.value = U.state.spotLightMap),
          (Et.pointShadowMap.value = U.state.pointShadowMap),
          (Et.pointShadowMatrix.value = U.state.pointShadowMatrix)),
        (B.currentProgram = Ct),
        (B.uniformsList = null),
        Ct
      );
    ...
    function Na(x) {
      if (x.uniformsList === null) {
        ...
        x.uniformsList = Cs.seqWithValue(D.seq, x.uniforms);
      }
    ...
    function Nl(x, D, O, B, U) {
      (D.isScene !== !0 && (D = Dt), Bt.resetTextureUnits());
      const J = D.fog,
        ...
        pt =
          N === null
            ...
            : N.isXRRenderTarget === !0
              ...
              : Mi,
        ut = (B.isMeshStandardMaterial ? le : me).get(B.envMap || lt),
        wt =
          B.vertexColors === !0 &&
          !!O.attributes.color &&
      ...
      let Gt = !1;
      B.version === Tt.__version
        ? ((Tt.needsLights && Tt.lightsStateVersion !== ne.state.version) ||
            Tt.outputColorSpace !== pt ||
            (U.isBatchedMesh && Tt.batching === !1) ||
            (!U.isBatchedMesh && Tt.batching === !0) ||
            (U.isBatchedMesh &&
              Tt.batchingColor === !0 &&
              U.colorTexture === null) ||
            (U.isBatchedMesh &&
              Tt.batchingColor === !1 &&
              U.colorTexture !== null) ||
            (U.isInstancedMesh && Tt.instancing === !1) ||
            (!U.isInstancedMesh && Tt.instancing === !0) ||
            (U.isSkinnedMesh && Tt.skinning === !1) ||
            (!U.isSkinnedMesh && Tt.skinning === !0) ||
            (U.isInstancedMesh &&
            ...
            (Tt.numClippingPlanes !== void 0 &&
              (Tt.numClippingPlanes !== et.numPlanes ||
                Tt.numIntersection !== et.numIntersection)) ||
            Tt.vertexAlphas !== wt ||
            ...
            Tt.morphColors !== qt ||
            Tt.toneMapping !== re ||
            Tt.morphTargetsCount !== $t) &&
          (Gt = !0)
        : ((Gt = !0), (Tt.__version = B.version));
      let we = Tt.currentProgram;
      Gt === !0 && (we = Ki(B, D, U));
      let Yn = !1,
        Re = !1,
        bi = !1;
      const ie = we.getUniforms(),
        Ue = Tt.uniforms;
      if (
        (Mt.useProgram(we.program) && ((Yn = !0), (Re = !0), (bi = !0)),
        B.id !== E && ((E = B.id), (Re = !0)),
        Yn || M !== x)
      ) {
        (Mt.buffers.depth.getReversed() &&
          ...
          ie.setValue(A, "projectionMatrix", x.projectionMatrix),
          ie.setValue(A, "viewMatrix", x.matrixWorldInverse));
        const ye = ie.map.cameraPosition;
        (ye !== void 0 &&
          ye.setValue(A, bt.setFromMatrixPosition(x.matrixWorld)),
          Wt.logarithmicDepthBuffer &&
            ie.setValue(
              A,
              "logDepthBufFC",
          ...
          (B.isMeshPhongMaterial ||
            ...
            B.isShaderMaterial) &&
            ie.setValue(A, "isOrthographic", x.isOrthographicCamera === !0),
          M !== x && ((M = x), (Re = !0), (bi = !0)));
      }
      if (U.isSkinnedMesh) {
        (ie.setOptional(A, U, "bindMatrix"),
          ie.setOptional(A, U, "bindMatrixInverse"));
        const Me = U.skeleton;
        Me &&
          (Me.boneTexture === null && Me.computeBoneTexture(),
          ie.setValue(A, "boneTexture", Me.boneTexture, Bt));
      }
      U.isBatchedMesh &&
        (ie.setOptional(A, U, "batchingTexture"),
        ie.setValue(A, "batchingTexture", U._matricesTexture, Bt),
        ie.setOptional(A, U, "batchingIdTexture"),
        ie.setValue(A, "batchingIdTexture", U._indirectTexture, Bt),
        ie.setOptional(A, U, "batchingColorTexture"),
        U._colorsTexture !== null &&
          ie.setValue(A, "batchingColorTexture", U._colorsTexture, Bt));
      ...
      if (
        ((Ie.position !== void 0 ||
          ...
          Ie.color !== void 0) &&
          Q.update(U, O, we),
        (Re || Tt.receiveShadow !== U.receiveShadow) &&
          ((Tt.receiveShadow = U.receiveShadow),
          ie.setValue(A, "receiveShadow", U.receiveShadow)),
        ...
        B.isMeshStandardMaterial &&
          B.envMap === null &&
          D.environment !== null &&
          (Ue.envMapIntensity.value = D.environmentIntensity),
        Re &&
          (ie.setValue(A, "toneMappingExposure", S.toneMappingExposure),
          Tt.needsLights && Fl(Ue, bi),
          J && B.fog === !0 && $.refreshFogUniforms(Ue, J),
          ...
          Cs.upload(A, Na(Tt), Ue, Bt)),
        B.isShaderMaterial &&
          B.uniformsNeedUpdate === !0 &&
          (Cs.upload(A, Na(Tt), Ue, Bt), (B.uniformsNeedUpdate = !1)),
        B.isSpriteMaterial && ie.setValue(A, "center", U.center),
        ie.setValue(A, "modelViewMatrix", U.modelViewMatrix),
        ie.setValue(A, "normalMatrix", U.normalMatrix),
        ie.setValue(A, "modelMatrix", U.matrixWorld),
        B.isShaderMaterial || B.isRawShaderMaterial)
      ) {
        const Me = B.uniformsGroups;
        for (let ye = 0, Gs = Me.length; ye < Gs; ye++) {
          const Pn = Me[ye];
          (It.update(Pn, we), It.bind(Pn, we));
        }
      }
      return we;
    }
    ...
    ((this.setRenderTarget = function (x, D = 0, O = 0) {
      ...
      if (x) {
        ...
        else if (ut.__webglFramebuffer === void 0) Bt.setupRenderTarget(x);
        ...
        (wt.isData3DTexture ||
          ...
          (lt = !0);
        const Ct = ft.get(x).__webglFramebuffer;
        (x.isWebGLCubeRenderTarget
          ? (Array.isArray(Ct[D]) ? (U = Ct[D][O]) : (U = Ct[D]), (J = !0))
          : x.samples > 0 && Bt.useMultisampledRTT(x) === !1
            ? (U = ft.get(x).__webglMultisampledFramebuffer)
            : Array.isArray(Ct)
              ? (U = Ct[O])
              : (U = Ct),
          b.copy(x.viewport),
      ...
      if (
        (O !== 0 && (U = Bl),
        Mt.bindFramebuffer(A.FRAMEBUFFER, U) && B && Mt.drawBuffers(x, U),
        Mt.viewport(b),
        Mt.scissor(W),
        Mt.setScissorTest(k),
        J)
      ...
      (this.readRenderTargetPixels = function (x, D, O, B, U, J, lt, pt = 0) {
        ...
        if ((x.isWebGLCubeRenderTarget && lt !== void 0 && (ut = ut[lt]), ut)) {
          ...
          try {
            const wt = x.textures[pt],
              Ct = wt.format,
              Et = wt.type;
            if (!Wt.textureFormatReadable(Ct)) {
              console.error(
                "THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.",
              );
              return;
            }
            if (!Wt.textureTypeReadable(Et)) {
              console.error(
            ...
            D >= 0 &&
              ...
              A.readPixels(D, O, B, U, vt.convert(Ct), vt.convert(Et), J));
          } finally {
            const wt = N !== null ? ft.get(N).__webglFramebuffer : null;
      ...
      (this.readRenderTargetPixelsAsync = async function (
        ...
        let ut = ft.get(x).__webglFramebuffer;
        if ((x.isWebGLCubeRenderTarget && lt !== void 0 && (ut = ut[lt]), ut))
          if (D >= 0 && D <= x.width - B && O >= 0 && O <= x.height - U) {
            Mt.bindFramebuffer(A.FRAMEBUFFER, ut);
            const wt = x.textures[pt],
              Ct = wt.format,
              Et = wt.type;
            ...
            (A.bindBuffer(A.PIXEL_PACK_BUFFER, Ht),
              A.bufferData(A.PIXEL_PACK_BUFFER, J.byteLength, A.STREAM_READ),
              x.textures.length > 1 && A.readBuffer(A.COLOR_ATTACHMENT0 + pt),
              A.readPixels(D, O, B, U, vt.convert(Ct), vt.convert(Et), 0));
            const qt = N !== null ? ft.get(N).__webglFramebuffer : null;
            Mt.bindFramebuffer(A.FRAMEBUFFER, qt);
            const re = A.fenceSync(A.SYNC_GPU_COMMANDS_COMPLETE, 0);
            return (
              A.flush(),
              await Cc(A, re, 4),
              A.bindBuffer(A.PIXEL_PACK_BUFFER, Ht),
      ...
      (this.copyFramebufferToTexture = function (x, D = null, O = 0) {
        const B = Math.pow(2, -O),
          ...
          pt = D !== null ? D.y : 0;
        (Bt.setTexture2D(x, 0),
          A.copyTexSubImage2D(A.TEXTURE_2D, O, 0, 0, lt, pt, U, J),
          Mt.unbindTexture());
      }));
    const zl = A.createFramebuffer(),
      Hl = A.createFramebuffer();
    ((this.copyTextureToTexture = function (
      ...
      J === null &&
        (U !== 0
          ? (mi(
            ...
            (U = 0))
          : (J = 0));
      let lt, pt, ut, wt, Ct, Et, Ht, qt, re;
      const Qt = x.isCompressedTexture ? x.mipmaps[J] : x.image;
      if (O !== null)
        ((lt = O.max.x - O.min.x),
          (pt = O.max.y - O.min.y),
        ...
        ((lt = Math.floor(Qt.width * Ie)),
          (pt = Math.floor(Qt.height * Ie)),
          x.isDataArrayTexture
            ? (ut = Qt.depth)
            : x.isData3DTexture
              ? (ut = Math.floor(Qt.depth * Ie))
              : (ut = 1),
          (wt = 0),
          (Ct = 0),
          (Et = 0));
      ...
      B !== null
        ? ((Ht = B.x), (qt = B.y), (re = B.z))
        : ((Ht = 0), (qt = 0), (re = 0));
      const $t = vt.convert(D.format),
        Tt = vt.convert(D.type);
      let ne;
      (D.isData3DTexture
        ? (Bt.setTexture3D(D, 0), (ne = A.TEXTURE_3D))
        : D.isDataArrayTexture || D.isCompressedArrayTexture
          ? (Bt.setTexture2DArray(D, 0), (ne = A.TEXTURE_2D_ARRAY))
          : (Bt.setTexture2D(D, 0), (ne = A.TEXTURE_2D)),
      ...
      const Gt = A.getParameter(A.UNPACK_ROW_LENGTH),
        we = A.getParameter(A.UNPACK_IMAGE_HEIGHT),
        Yn = A.getParameter(A.UNPACK_SKIP_PIXELS),
        Re = A.getParameter(A.UNPACK_SKIP_ROWS),
        bi = A.getParameter(A.UNPACK_SKIP_IMAGES);
      (A.pixelStorei(A.UNPACK_ROW_LENGTH, Qt.width),
        A.pixelStorei(A.UNPACK_IMAGE_HEIGHT, Qt.height),
        A.pixelStorei(A.UNPACK_SKIP_PIXELS, wt),
        A.pixelStorei(A.UNPACK_SKIP_ROWS, Ct),
        A.pixelStorei(A.UNPACK_SKIP_IMAGES, Et));
      const ie = x.isDataArrayTexture || x.isData3DTexture,
        Ue = D.isDataArrayTexture || D.isData3DTexture;
      if (x.isDepthTexture) {
        const Ie = ft.get(x),
          Me = ft.get(D),
          ye = ft.get(Ie.__renderTarget),
          Gs = ft.get(Me.__renderTarget);
        (Mt.bindFramebuffer(A.READ_FRAMEBUFFER, ye.__webglFramebuffer),
          Mt.bindFramebuffer(A.DRAW_FRAMEBUFFER, Gs.__webglFramebuffer));
        for (let Pn = 0; Pn < ut; Pn++)
          (ie &&
            (A.framebufferTextureLayer(
              A.READ_FRAMEBUFFER,
              A.COLOR_ATTACHMENT0,
        ...
        const Ie = ft.get(x),
          Me = ft.get(D);
        (Mt.bindFramebuffer(A.READ_FRAMEBUFFER, zl),
          Mt.bindFramebuffer(A.DRAW_FRAMEBUFFER, Hl));
        for (let ye = 0; ye < ut; ye++)
          (ie
            ? A.framebufferTextureLayer(
                A.READ_FRAMEBUFFER,
                A.COLOR_ATTACHMENT0,
            ...
            U !== 0
              ...
              : Ue
                ? A.copyTexSubImage3D(ne, J, Ht, qt, re + ye, wt, Ct, lt, pt)
                : A.copyTexSubImage2D(ne, J, Ht, qt, wt, Ct, lt, pt));
        (Mt.bindFramebuffer(A.READ_FRAMEBUFFER, null),
          Mt.bindFramebuffer(A.DRAW_FRAMEBUFFER, null));
      } else
        Ue
          ? x.isDataTexture || x.isData3DTexture
            ? A.texSubImage3D(ne, J, Ht, qt, re, lt, pt, ut, $t, Tt, Qt.data)
            : D.isCompressedArrayTexture
              ...
              : A.texSubImage3D(ne, J, Ht, qt, re, lt, pt, ut, $t, Tt, Qt)
          : x.isDataTexture
            ? A.texSubImage2D(A.TEXTURE_2D, J, Ht, qt, lt, pt, $t, Tt, Qt.data)
            : x.isCompressedTexture
              ...
              : A.texSubImage2D(A.TEXTURE_2D, J, Ht, qt, lt, pt, $t, Tt, Qt);
      (A.pixelStorei(A.UNPACK_ROW_LENGTH, Gt),
        A.pixelStorei(A.UNPACK_IMAGE_HEIGHT, we),
        A.pixelStorei(A.UNPACK_SKIP_PIXELS, Yn),
        A.pixelStorei(A.UNPACK_SKIP_ROWS, Re),
        A.pixelStorei(A.UNPACK_SKIP_IMAGES, bi),
        J === 0 && D.generateMipmaps && A.generateMipmap(ne),
        Mt.unbindTexture());
    }),
      (this.copyTextureToTexture3D = function (
        ...
        return (
          ...
          this.copyTextureToTexture(x, D, O, B, U)
        );
      }),
      (this.initRenderTarget = function (x) {
        ft.get(x).__webglFramebuffer === void 0 && Bt.setupRenderTarget(x);
      }),
      (this.initTexture = function (x) {
        (x.isCubeTexture
          ? Bt.setTextureCube(x, 0)
          : x.isData3DTexture
            ? Bt.setTexture3D(x, 0)
            : x.isDataArrayTexture || x.isCompressedArrayTexture
              ? Bt.setTexture2DArray(x, 0)
              : Bt.setTexture2D(x, 0),
          Mt.unbindTexture());
      }),
  ...
  set outputColorSpace(t) {
    ...
    ((e.drawingBufferColorSpace = kt._getDrawingBufferColorSpace(t)),
      (e.unpackColorSpace = kt._getUnpackColorSpace()));
  }
}
...
class im extends gh {
  constructor(t, e = null) {
    (super(t, e),
      ...
      (this._quat = new Wn().setFromUnitVectors(t.up, new I(0, 1, 0))),
      (this._quatInverse = this._quat.clone().invert()),
      (this._spherical = new _o()),
      (this._sphericalDelta = new _o()),
      (this._scale = 1),
      ...
      (this._onPointerMove = rm.bind(this)),
      (this._onPointerDown = sm.bind(this)),
      (this._onPointerUp = am.bind(this)),
      (this._onContextMenu = fm.bind(this)),
      (this._onMouseWheel = cm.bind(this)),
      (this._onKeyDown = hm.bind(this)),
      (this._onTouchStart = um.bind(this)),
      (this._onTouchMove = dm.bind(this)),
      (this._onMouseDown = om.bind(this)),
      (this._onMouseMove = lm.bind(this)),
  ...
  update(t = null) {
    ...
    if (
      (ue.setFromSpherical(this._spherical),
      ...
      a !== null &&
        (this.screenSpacePanning
          ...
          : (Ss.origin.copy(this.object.position),
            Ss.direction.set(0, 0, -1).transformDirection(this.object.matrix),
            Math.abs(this.object.up.dot(Ss.direction)) < nm
              ? this.object.lookAt(this.target)
              : (Go.setFromNormalAndCoplanarPoint(this.object.up, this.target),
                Ss.intersectPlane(Go, this.target))));
    } else if (this.object.isOrthographicCamera) {
  ...
  _getAutoRotationAngle(t) {
    return t !== null
      ? (be / 60) * this.autoRotateSpeed * t
      : (be / 60 / 60) * this.autoRotateSpeed;
  }
  _getZoomScale(t) {
  ...
  _panUp(t, e) {
    (this.screenSpacePanning === !0
      ? ue.setFromMatrixColumn(e, 1)
      : (ue.setFromMatrixColumn(e, 0), ue.crossVectors(this.object.up, ue)),
      ue.multiplyScalar(t),
      this._panOffset.add(ue));
  }
  _pan(t, e) {
    ...
    switch (t.code) {
      case this.keys.UP:
        (t.ctrlKey || t.metaKey || t.shiftKey
          ? this.enableRotate &&
            this._rotateUp(
              (be * this.keyRotateSpeed) / this.domElement.clientHeight,
            )
...
function om(i) {
  ...
  this.state !== jt.NONE && this.dispatchEvent(Ca);
}
function lm(i) {
  switch (this.state) {
    case jt.ROTATE:
...
class _m extends yi {
  ...
  load(t, e, n, s) {
    const r = this,
      a = this.path === "" ? ph.extractUrlBase(t) : this.path,
...
`);
    ...
    const o = new gm(this.resourcePath || e, this.materialOptions);
    return (
...
class gm {
  constructor(t = "", e = {}) {
    ((this.baseUrl = t),
      ...
      (this.nameLookup = {}),
      (this.crossOrigin = "anonymous"),
      (this.side = this.options.side !== void 0 ? this.options.side : mn),
      (this.wrap = this.options.wrap !== void 0 ? this.options.wrap : Ps));
  }
  setCrossOrigin(t) {
    return ((this.crossOrigin = t), this);
  }
  ...
  createMaterial_(t) {
    ...
    function a(o, c) {
      ...
      (u.repeat.copy(l.scale),
        ...
        (u.wrapS = e.wrap),
        (u.wrapT = e.wrap),
        (o === "map" || o === "emissiveMap") && (u.colorSpace = ge),
        (s[o] = u));
    }
    for (const o in n) {
      const c = n[o];
      ...
      if (c !== "")
        switch (o.toLowerCase()) {
          case "kd":
            s.color = kt.colorSpaceToWorking(new Lt().fromArray(c), ge);
            break;
          case "ks":
            s.specular = kt.colorSpaceToWorking(new Lt().fromArray(c), ge);
            break;
          case "ke":
            s.emissive = kt.colorSpaceToWorking(new Lt().fromArray(c), ge);
            break;
          case "map_kd":
            a("map", c);
            break;
    ...
    return ((this.materials[t] = new gl(s)), this.materials[t]);
  }
  getTextureParams(t, e) {
    const n = { scale: new Pt(1, 1), offset: new Pt(0, 0) },
      s = t.split(/\s+/);
    let r;
    return (
      (r = s.indexOf("-bm")),
  ...
  loadTexture(t, e, n, s, r) {
    const a = this.manager !== void 0 ? this.manager : xl;
...
`);
    ...
    for (let o = 0, c = n.length; o < c; o++) {
      ...
      if (u !== "#")
        if (u === "v") {
          ...
          const f = l.slice(1).trim().split(Wo),
            p = [];
    ...
    if (
      ...
      for (let o = 0, c = e.objects.length; o < c; o++) {
        ...
        const v = new De();
        (v.setAttribute("position", new he(u.vertices, 3)),
          u.normals.length > 0 &&
            v.setAttribute("normal", new he(u.normals, 3)),
          u.colors.length > 0 &&
            ((g = !0), v.setAttribute("color", new he(u.colors, 3))),
          u.hasUVIndices === !0 && v.setAttribute("uv", new he(u.uvs, 2)));
        const m = [];
        for (let w = 0, T = h.length; w < T; w++) {
          ...
          if (this.materials !== null) {
            if (
              ...
              const C = new Ii();
              (en.prototype.copy.call(C, R), C.color.copy(R.color), (R = C));
            } else if (p && R && !(R instanceof Di)) {
              const C = new Di({ size: 10, sizeAttenuation: !1 });
              (en.prototype.copy.call(C, R),
          ...
          (R === void 0 &&
            (f
              ? (R = new Ii())
              : p
                ? (R = new Di({ size: 1, sizeAttenuation: !1 }))
                : (R = new gl()),
            (R.name = S.name),
        ...
        if (m.length > 1) {
          ...
          f ? (d = new ha(v, m)) : p ? (d = new mr(v, m)) : (d = new Le(v, m));
        } else
          f
            ? (d = new ha(v, m[0]))
            : p
      ...
      const o = new Di({ size: 1, sizeAttenuation: !1 }),
        c = new De();
      (c.setAttribute("position", new he(e.vertices, 3)),
        e.colors.length > 0 &&
          e.colors[0] !== void 0 &&
          (c.setAttribute("color", new he(e.colors, 3)),
          (o.vertexColors = !0)));
      const l = new mr(c, o);
      r.add(l);
    }
...
const Ve = (i, t = "") =>
    `<svg class="${t}" viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">${{ book: '<path d="M4 5.5A2.5 2.5 0 0 1 6.5 3H11v17H6.5A2.5 2.5 0 0 0 4 22.5z"/><path d="M20 5.5A2.5 2.5 0 0 0 17.5 3H13v17h4.5a2.5 2.5 0 0 1 2.5 2.5z"/>', layers: '<path d="m12 2 9 5-9 5-9-5z"/><path d="m3 12 9 5 9-5"/><path d="m3 17 9 5 9-5"/>', clock: '<circle cx="12" cy="12" r="9"/><path d="M12 3v9h7"/>', trend: '<path d="m3 17 6-7 4 4 8-10"/><path d="M16 4h5v5"/>', user: '<circle cx="12" cy="8" r="4" fill="currentColor" stroke="none"/><path d="M5 21a7 7 0 0 1 14 0z" fill="currentColor" stroke="none"/>', chevronDown: '<path d="m7 9 5 5 5-5"/>', chevronLeft: '<path d="m15 18-6-6 6-6"/>', chevronRight: '<path d="m9 18 6-6-6-6"/>', star: '<path d="m12 3 2.7 5.5 6.1.9-4.4 4.3 1 6.1-5.4-2.9-5.4 2.9 1-6.1-4.4-4.3 6.1-.9z"/>', mouse: '<rect x="7" y="3" width="10" height="18" rx="5"/><path d="M12 3v6"/>', plane: '<path d="M22 16.2 13.7 13v6.1l2.3 1.6v1L12 21l-4 .7v-1l2.3-1.6V13L2 16.2v-1.7l8.3-6.2V3.8C10.3 2.8 11 2 12 2s1.7.8 1.7 1.8v4.5l8.3 6.2z" fill="currentColor" stroke="none"/>' }[i]}</svg>`,
  Be = [
    {
  ...
  <main class="app-shell">
    <header class="topbar">
      ...
      <nav class="main-nav" aria-label="Primary navigation">
        <button class="nav-item active" type="button">${Ve("book")}<span>Lessons</span></button>
        <button class="nav-item" type="button">${Ve("layers")}<span>Library</span></button>
        <button class="nav-item" type="button">${Ve("clock")}<span>Quizzes</span></button>
        <button class="nav-item" type="button">${Ve("trend")}<span>Progress</span></button>
      </nav>
      <button class="profile" type="button" aria-label="Open profile menu">
        <span class="profile-avatar">${Ve("user")}</span>${Ve("chevronDown")}
      </button>
    </header>
    ...
    <section class="workspace">
      <section class="lesson-main" aria-label="Interactive lesson">
        <div class="lesson-progress">
          ...
          <div class="progress-track" aria-label="Story progress">
            ...
            <div class="progress-dots">
              ${Be.map((i, t) => `<button type="button" class="progress-dot ${t === 0 ? "active" : ""}" data-slide="${t}" aria-label="Go to slide ${t + 1}"></button>`).join("")}
            </div>
          </div>
        </div>
        ...
        <div class="scene-wrap">
          ...
          <div class="scene-help">${Ve("mouse")} Drag to explore</div>
        </div>

        <div class="slide-strip" role="tablist" aria-label="Lesson slides">
          ${Be.map(
            (i, t) => `
            <button type="button" class="slide-card ${t === 0 ? "active" : ""}" data-slide="${t}" role="tab" aria-selected="${t === 0}">
              <span class="card-art">${t === 0 ? '<i class="mini-plane"></i>' : ""}</span>
              <span class="card-number">${t + 1}</span>
              <span class="card-copy"><strong>${i.title}</strong>${i.subtitle ? `<span>${i.subtitle}</span>` : ""}</span>
            </button>
          `,
          ).join("")}
        </div>
      ...
      <aside class="info-panel" aria-live="polite">
        ...
        <p class="slide-description">${Be[0].description}</p>
        <div class="points-box">
          <div class="points-title"><span class="star-icon">${Ve("star")}</span><span>Key Points</span></div>
    ...
    <footer class="bottom-bar">
      <button type="button" class="footer-btn back-btn">${Ve("chevronLeft")}<span>Back</span></button>
      <div class="flight-path" aria-hidden="true">${Ve("plane", "footer-plane")}</div>
      <button type="button" class="footer-btn continue-btn"><span>Continue</span>${Ve("chevronRight")}</button>
    </footer>
  </main>
`;
const Tm = document.querySelector(".points-list"),
  bm = document.querySelector(".info-panel h1"),
  Am = document.querySelector(".slide-description"),
  wm = document.querySelector(".slide-count"),
  Rm = document.querySelector(".hotspots"),
  Cm = document.querySelector(".progress-fill"),
  Pl = document.querySelector(".scene-loading");
let ki = 0;
function Ll(i) {
  Tm.innerHTML = i
    .map(
      ([t, e]) => `
    <li><span class="point-dot"></span><span class="point-copy"><strong>${t}</strong><span>${e}</span></span></li>
  `,
    )
    .join("");
}
Ll(Be[0].points);
const di = document.querySelector("#scene-canvas"),
  sn = new th();
sn.fog = new Ta(133912, 0.06);
const wn = new Oe(34, 1, 0.1, 100);
wn.position.set(...Be[0].camera);
const Qe = new em({
  canvas: di,
  antialias: !0,
  alpha: !0,
...
Qe.setPixelRatio(Math.min(window.devicePixelRatio, 1.75));
Qe.outputColorSpace = ge;
Qe.toneMapping = $o;
Qe.toneMappingExposure = 1.08;
Qe.shadowMap.enabled = !0;
Qe.shadowMap.type = Ko;
const nn = new im(wn, di);
nn.enableDamping = !0;
nn.dampingFactor = 0.055;
nn.enablePan = !1;
nn.minDistance = 3.8;
nn.maxDistance = 12;
nn.maxPolarAngle = Math.PI * 0.72;
nn.target.set(...Be[0].target);
sn.add(new uh(11130111, 331808, 2.5));
const zs = new wa(16777215, 3.8);
zs.position.set(-4, 8, 5);
zs.castShadow = !0;
zs.shadow.mapSize.set(1024, 1024);
sn.add(zs);
const Dl = new wa(1477887, 3.2);
Dl.position.set(6, 2, -5);
sn.add(Dl);
const Ul = new wa(9226239, 1.7);
Ul.position.set(-7, 0, -2);
sn.add(Ul);
const Hs = new Le(
  new Yi(40, 40, 40, 40),
  new rh({
...
Hs.receiveShadow = !0;
sn.add(Hs);
const ks = new _h(34, 34, 1462909, 1062486);
ks.position.y = -1.165;
ks.material.opacity = 0.31;
ks.material.transparent = !0;
sn.add(ks);
const Pa = new Le(
  new Aa(3.8, 64),
  new ya({ color: 554434, transparent: !0, opacity: 0.06, depthWrite: !1 }),
);
...
let On, En;
const Ns = new vl();
Ns.onLoad = () => Pl.classList.add("hidden");
Ns.onError = () => {
  Pl.innerHTML = "<span>Aircraft model unavailable</span>";
};
new _m(Ns).setPath("./").load("11803_Airplane_v1_l1.mtl", (i) => {
  (i.preload(),
    new ym(Ns)
      .setMaterials(i)
      .setPath("./")
      .load("11803_Airplane_v1_l1.obj", (t) => {
        const e = new Ei().setFromObject(t),
          n = e.getCenter(new I()),
          s = e.getSize(new I());
        (t.position.sub(n),
          (On = new hi()),
          On.add(t),
          On.scale.setScalar(6.3 / Math.max(s.x, s.y)),
          (On.rotation.x = Math.PI / 2),
          ...
          t.traverse((r) => {
            r.isMesh &&
              ...
              (r.receiveShadow = !0),
              (r.material.side = Ke),
              (r.material.shininess = Math.min(r.material.shininess || 30, 45)),
...
function Pm(i) {
  En = {
    ...
    fromPosition: wn.position.clone(),
    toPosition: new I(...i.camera).multiplyScalar(1 / i.zoom),
    fromTarget: nn.target.clone(),
    toTarget: new I(...i.target),
  };
}
function Vi(i) {
  if (i < 0 || i >= Be.length) return;
  ki = i;
  const t = Be[i];
  ((bm.textContent = t.title),
    (Am.textContent = t.description),
    (wm.textContent = `Story slide ${i + 1} of ${Be.length}`),
    Ll(t.points),
    (Rm.hidden = i !== 0),
    (Cm.style.width = `${(i / (Be.length - 1)) * 100}%`),
    document.querySelectorAll("[data-slide]").forEach((n) => {
      const s = Number(n.dataset.slide) === i;
      (n.classList.toggle("active", s),
        n.matches(".slide-card") && n.setAttribute("aria-selected", String(s)));
    }),
    document
...
document.querySelectorAll("[data-slide]").forEach((i) => {
  i.addEventListener("click", () => Vi(Number(i.dataset.slide)));
});
document.querySelector(".continue-btn").addEventListener("click", () => {
  Vi(Math.min(ki + 1, Be.length - 1));
});
document.querySelector(".back-btn").addEventListener("click", () => {
  Vi(Math.max(ki - 1, 0));
});
document.addEventListener("keydown", (i) => {
  (i.key === "ArrowRight" && Vi(Math.min(ki + 1, Be.length - 1)),
    i.key === "ArrowLeft" && Vi(Math.max(ki - 1, 0)));
});
function Lm() {
  const i = di.clientWidth,
    t = di.clientHeight;
  (di.width !== Math.floor(i * Qe.getPixelRatio()) ||
    di.height !== Math.floor(t * Qe.getPixelRatio())) &&
    (Qe.setSize(i, t, !1),
    (wn.aspect = i / t),
    (wn.fov = i < 600 ? 57 : i < 900 ? 43 : 34),
...
function Il(i) {
  if ((requestAnimationFrame(Il), Lm(), En)) {
    const t = Math.min((i - En.started) / 850, 1),
      e = Dm(t);
    (wn.position.lerpVectors(En.fromPosition, En.toPosition, e),
      nn.target.lerpVectors(En.fromTarget, En.toTarget, e),
      t === 1 && (En = null));
  }
  (nn.update(), Qe.render(sn, wn));
}

...
References: `main.go:20-34`, `model.go:181-188`
...
References: `model.go:254-286`, `model.go:569-582`
...
References: `model.go:143-152`, `model.go:254-286`, `model.go:411-422`, `store.go:93-141`, `store.go:143-263`
...
References: `model.go:143-152`, `model.go:404-409`
...
References: `main.go:20-34`, `model.go:411-422`, `store.go:39-58`, `store.go:143-227`
...
References: `model.go:189-196`, `model.go:254-286`, `model.go:301-317`, `model.go:349-360`

### 7. Persistence test gaps remain

Persistence tests cover pasted-content autosave, repeated replacement, failed writes, malformed JSON, rollback, and recovery. Final shutdown saves, stale autosave timers, autosave retry, and preserving an existing export after failure remain untested. Current statement coverage is 82.9%.
...
References: `model.go:430-439`, `model.go:481-518`, `model.go:611-621`
...
References: `model.go:153-166`, `model.go:181-188`, `model.go:254-261`, `model.go:549-561`
...
References: `model.go:133-178`, `model.go:237-251`, `model.go:404-409`, `model_test.go:262-282`

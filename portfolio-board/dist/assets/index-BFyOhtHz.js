...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Bs(e,t,n){let r=new Float32Array(Es),i=new G(0,1,0);return new co({name:`SphericalGaussianBlur`,defines:{n:Es,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Us(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Vs(){return new co({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Us(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Hs(){return new co({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Us(),fragmentShader:`
	...
	`}var Ws=class extends nn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Di(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};zu.BlurDirectionX=new W(1,0),zu.BlurDirectionY=new W(0,1);var Bu={initials:`AR`,name:`Alex Rivera`,title:`Software Engineer`,eyebrow:`Three.js powered resume`,headlinePrefix:`My`,headlineLead:`career.`,headlineAccent:`Visualized.`,introduction:`An interactive 3D map of my journey, skills, and growth - built with code and designed for exploration.`,email:`hello@alexrivera.dev`,resumeUrl:`#resume`},Vu=[{label:`Home`,href:`#home`},{label:`About`,href:`#about`},{label:`Experience`,href:`#experience`},{label:`Skills`,href:`#skills`},{label:`Projects`,href:`#projects`},{label:`Contact`,href:`#contact`}],Hu=[{id:`junior`,year:`2019`,role:`Junior Developer`,company:`Northstar Studio`,summary:`Built accessible interfaces and learned to ship dependable product work.`,position:[-4.9,-1.15,.56]},{id:`software`,year:`2020`,role:`Software Engineer`,company:`Fieldwork Labs`,summary:`Owned full-stack features and introduced a typed frontend platform.`,position:[-1.75,.05,.56]},{id:`senior`,year:`2022`,role:`Senior Engineer`,company:`Orbit Systems`,summary:`Led platform architecture and mentored engineers across product teams.`,position:[1.45,.7,.56]},{id:`lead`,year:`2024`,role:`Lead Engineer`,company:`Signal Works`,summary:`Guides technical direction for resilient, high-impact web products.`,position:[4.75,1.62,.56],current:!0}],Uu=[{id:`react`,name:`React`,mark:`RE`,category:`frontend`,level:`Advanced`,summary:`Composable interfaces, accessibility, and modern application architecture.`,milestoneId:`junior`,position:[-3.7,-2.65,.65]},{id:`typescript`,name:`TypeScript`,mark:`TS`,category:`frontend`,level:`Advanced`,summary:`Strong domain models and safe APIs across frontend and backend systems.`,milestoneId:`software`,position:[-1.05,-2.38,.65]},{id:`system-design`,name:`System Design`,mark:`SD`,category:`platform`,level:`Advanced`,summary:`Scalable service boundaries, data flows, and pragmatic tradeoffs.`,milestoneId:`software`,position:[1.15,-2.75,.65]},{id:`node`,name:`Node.js`,mark:`JS`,category:`backend`,level:`Advanced`,summary:`Production APIs, asynchronous workflows, and service observability.`,milestoneId:`senior`,position:[2.05,-1.35,.65]},{id:`three`,name:`Three.js`,mark:`3D`,category:`frontend`,level:`Proficient`,summary:`Interactive WebGL scenes, custom geometry, and expressive motion.`,milestoneId:`lead`,position:[4.4,-.1,.65]},{id:`cicd`,name:`CI/CD`,mark:`CI`,category:`platform`,level:`Advanced`,summary:`Fast, observable delivery pipelines with reliable quality gates.`,milestoneId:`lead`,position:[5.15,-1.75,.65]}],Wu={profileUrl:`https://github.com/alexrivera?tab=overview`,handle:`@alexrivera`,totalContributions:842,currentStreak:18,activity:[0,2,4,1,0,3,6,2,1,5,3,0,4,7,2,5,1,3,6,4,0,2,7,5,3,1,4,6]};function Gu(){let e=new Set(Hu.map(({id:e})=>e)),t=[...Hu,...Uu].map(({id:e})=>e),n=new Set(t).size===t.length,r=Uu.every(({milestoneId:t})=>e.has(t));if(!n||!r||Hu.length===0)throw Error(`Resume data is incomplete or contains invalid relationships.`)}var Ku=e((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),$=e(((e,t)=>{t.exports=Ku()}))(),qu=new q(`#12f1f3`),Ju=new q(`#9dff45`),Yu=13.2,Xu=7.6,Zu={x:-.09,y:-.07,z:-.035},Qu={minX:-.72,maxX:.38,minY:-.58,maxY:.52},$u=.0034;function ed(e,t,n,r,i=.06,a=Math.min(n*.22,.08)){let o=-e/2,s=-t/2,c=new da;c.moveTo(o+n,s),c.lineTo(o+e-n,s),c.quadraticCurveTo(o+e,s,o+e,s+n),c.lineTo(o+e,s+t-n),c.quadraticCurveTo(o+e,s+t,o+e-n,s+t),c.lineTo(o+n,s+t),c.quadraticCurveTo(o,s+t,o,s+t-n),c.lineTo(o,s+n),c.quadraticCurveTo(o,s,o+n,s);let l=new Ya(c,{depth:r,bevelEnabled:!0,bevelSegments:i<.02?2:3,bevelSize:a,bevelThickness:i,curveSegments:8});return l.computeVertexNormals(),l}function td(){let e=document.createElement(`canvas`);e.width=1024,e.height=576;let t=e.getContext(`2d`),n=74121,r=()=>(n=n*1664525+1013904223>>>0,n/4294967296),i=t.createLinearGradient(0,0,e.width,e.height);i.addColorStop(0,`#2b3134`),i.addColorStop(.42,`#232a2d`),i.addColorStop(1,`#1a2124`),t.fillStyle=i,t.fillRect(0,0,e.width,e.height);let a=t.createRadialGradient(360,190,20,360,190,620);a.addColorStop(0,`rgba(118, 127, 130, 0.11)`),a.addColorStop(.55,`rgba(65, 73, 76, 0.025)`),a.addColorStop(1,`rgba(0, 0, 0, 0.12)`),t.fillStyle=a,t.fillRect(0,0,e.width,e.height);for(let n=0;n<18;n+=1){let n=r()*e.width,i=r()*e.height,a=80+r()*190,o=r()>.52,s=t.createRadialGradient(n,i,0,n,i,a);s.addColorStop(0,o?`rgba(145, 151, 153, 0.022)`:`rgba(0, 0, 0, 0.026)`),s.addColorStop(1,`rgba(0, 0, 0, 0)`),t.fillStyle=s,t.fillRect(n-a,i-a,a*2,a*2)}t.lineWidth=1,t.strokeStyle=`rgba(145, 154, 156, 0.035)`;for(let n=0;n<9;n+=1){let n=30+r()*180,i=28+r()*(e.height-56),a=70+r()*150,o=(r()>.5?1:-1)*(18+r()*48),s=90+r()*210;t.beginPath(),t.moveTo(n,i),t.lineTo(n+a,i),t.lineTo(n+a+24,i+o),t.lineTo(n+a+s,i+o),t.stroke()}let o=t.getImageData(0,0,e.width,e.height);for(let e=0;e<o.data.length;e+=4){let t=Math.floor(r()*5)-2;o.data[e]+=t,o.data[e+1]+=t,o.data[e+2]+=t}t.putImageData(o,0,0),t.fillStyle=`rgba(172, 179, 180, 0.075)`;for(let n=0;n<65;n+=1){let n=r()*e.width,i=r()*e.height,a=r()>.8?1.4:.7;t.beginPath(),t.arc(n,i,a,0,Math.PI*2),t.fill()}let s=new Oi(e);return s.colorSpace=Ke,s.anisotropy=8,s}function nd(e,t,n){let r=document.createElement(`canvas`);r.width=512,r.height=288;let i=r.getContext(`2d`),a=i.createImageData(r.width,r.height);for(let r=0;r<a.data.length;r+=4){e=e*1664525+1013904223>>>0;let i=t+Math.floor(e/4294967296*n);a.data[r]=i,a.data[r+1]=i,a.data[r+2]=i,a.data[r+3]=255}i.putImageData(a,0,0);let o=new Oi(r);return o.colorSpace=``,o.anisotropy=4,o}function rd(e,t,n,r,i){let a=new la,o=-e/2,s=e/2,c=-t/2,l=t/2,u=(e,t)=>new G(e,t,r);return a.add(new ia(u(o+n,c),u(s-n,c))),a.add(new oa(u(s-n,c),u(s,c),u(s,c+n))),a.add(new ia(u(s,c+n),u(s,l-n))),a.add(new oa(u(s,l-n),u(s,l),u(s-n,l))),a.add(new ia(u(s-n,l),u(o+n,l))),a.add(new oa(u(o+n,l),u(o,l),u(o,l-n))),a.add(new ia(u(o,l-n),u(o,c+n))),a.add(new oa(u(o,c+n),u(o,c),u(o+n,c))),new Ei(new Ir().setFromPoints(a.getPoints(160)),new _i({color:i,transparent:!0,opacity:.72,toneMapped:!1}))}function id(e,t,n,r,i){let a=-e/2,o=-t/2,s=new da;s.moveTo(a+n,o),s.lineTo(a+e-n,o),s.quadraticCurveTo(a+e,o,a+e,o+n),s.lineTo(a+e,o+t-n),s.quadraticCurveTo(a+e,o+t,a+e-n,o+t),s.lineTo(a+n,o+t),s.quadraticCurveTo(a,o+t,a,o+t-n),s.lineTo(a,o+n),s.quadraticCurveTo(a,o,a+n,o);let c=s.getSpacedPoints(128);return c.pop(),new ai(new eo(new Wi(c.map(e=>new G(e.x,e.y,r)),!0,`centripetal`),160,.009,5,!0),new qr({color:i,transparent:!0,opacity:.78,toneMapped:!0}))}function ad(e,t,n){let r=document.createElement(`canvas`);r.width=256,r.height=256;let i=r.getContext(`2d`);if(i.clearRect(0,0,256,256),i.strokeStyle=n,i.fillStyle=n,i.lineWidth=10,i.lineCap=`round`,i.lineJoin=`round`,i.textAlign=`center`,i.textBaseline=`middle`,i.save(),i.translate(128,96),i.scale(.68,.68),i.translate(-128,-128),e===`RE`){for(let e of[0,Math.PI/3,-Math.PI/3])i.save(),i.translate(128,128),i.rotate(e),i.beginPath(),i.ellipse(0,0,76,27,0,0,Math.PI*2),i.stroke(),i.restore();i.beginPath(),i.arc(128,128,11,0,Math.PI*2),i.fill()}else if(e===`TS`)i.fillRect(49,49,158,158),i.fillStyle=`#020607`,i.font=`700 70px IBM Plex Mono, monospace`,i.fillText(`TS`,128,136);else if(e===`SD`)for(let e of[-38,0,38])i.beginPath(),i.moveTo(128,55+e),i.lineTo(202,94+e),i.lineTo(128,133+e),i.lineTo(54,94+e),i.closePath(),i.stroke();else if(e===`JS`){i.beginPath();for(let e=0;e<6;e+=1){let t=-Math.PI/2+e*Math.PI/3,n=128+Math.cos(t)*82,r=128+Math.sin(t)*82;e===0?i.moveTo(n,r):i.lineTo(n,r)}i.closePath(),i.stroke(),i.font=`700 58px IBM Plex Mono, monospace`,i.fillText(`JS`,128,132)}else e===`3D`?(i.beginPath(),i.moveTo(128,42),i.lineTo(212,192),i.lineTo(44,192),i.closePath(),i.moveTo(128,42),i.lineTo(128,152),i.moveTo(44,192),i.lineTo(128,152),i.lineTo(212,192),i.stroke()):e===`CI`?(i.beginPath(),i.moveTo(128,128),i.bezierCurveTo(87,67,35,77,35,128),i.bezierCurveTo(35,179,87,189,128,128),i.bezierCurveTo(169,67,221,77,221,128),i.bezierCurveTo(221,179,169,189,128,128),i.stroke()):(i.font=`700 72px IBM Plex Mono, monospace`,i.fillText(e,128,132));i.restore(),i.fillStyle=`#edf3f3`,i.font=`${t.length>10?24:29}px Space Grotesk, sans-serif`,i.fillText(t,128,210);let a=new Oi(r);return a.colorSpace=Ke,a.anisotropy=4,a}function od(){let e=document.createElement(`canvas`);e.width=256,e.height=224;let t=e.getContext(`2d`);t.shadowColor=`rgba(0, 0, 0, 0.78)`,t.shadowBlur=26,t.shadowOffsetX=7,t.shadowOffsetY=10,t.fillStyle=`rgba(0, 0, 0, 0.48)`,t.beginPath(),t.roundRect(37,29,176,154,24),t.fill();let n=new Oi(e);return n.colorSpace=Ke,n.minFilter=_,n.magFilter=_,n}function sd(e,t,n,r,i,a){let o=document.createElement(`button`);o.type=`button`,o.className=`scene-label ${t}-label`,o.dataset.id=n,o.setAttribute(`aria-label`,`View details for ${[r,i].filter(Boolean).join(` `)}`);let s=document.createElement(`span`);if(s.className=`scene-label-title`,s.textContent=i,r){let e=document.createElement(`span`);e.className=`scene-label-accent`,e.textContent=r,o.append(e)}return o.append(s),o.addEventListener(`click`,()=>a(n)),e.append(o),o}function cd(e){return e===`backend`?`#9dff45`:e===`platform`?`#55f29a`:`#12f1f3`}var ld=(0,l.forwardRef)(function({selectedId:e,onSelect:t},n){let r=(0,l.useRef)(null),i=(0,l.useRef)(null),a=(0,l.useRef)(null),o=(0,l.useRef)(()=>void 0),s=(0,l.useRef)(()=>void 0),c=(0,l.useRef)(e),u=(0,l.useRef)(t);return c.current=e,u.current=t,(0,l.useImperativeHandle)(n,()=>({resetView:()=>o.current(),focusFirst:()=>s.current()}),[]),(0,l.useEffect)(()=>{let e=r.current,t=i.current,n=a.current;if(!e||!t||!n)return;let l=window.matchMedia(`(prefers-reduced-motion: reduce)`),d=new Hn,f=new zo(39,1,.1,100);f.position.set(0,.1,14.7);let p=new Du({canvas:t,alpha:!0,antialias:!0,powerPreference:`high-performance`});p.outputColorSpace=Ke,p.toneMapping=4,p.toneMappingExposure=1.05,p.shadowMap.enabled=!1,p.setClearColor(0,0);let m=new Iu(p),h=new Lu(d,f),g=new zu(new W(1,1),.36,.1,.9);m.addPass(h),m.addPass(g);let _=new Pn;_.rotation.set(Zu.x,Zu.y,Zu.z),_.position.set(.45,-.05,0),d.add(_);let v=td(),y=nd(91827,120,17),b=nd(31415,238,17),x=new fo({color:`#ffffff`,map:v,bumpMap:y,bumpScale:.016,roughnessMap:b,metalness:.08,roughness:1,clearcoat:.02,clearcoatRoughness:1}),S=new uo({color:`#151d20`,metalness:.06,roughness:.96}),C=new ai(ed(Yu,Xu,.42,.34),x);C.position.z=0,_.add(C);let w=new ai(ed(13.28,7.68,.44,.34),S);w.position.z=-.36,_.add(w);let T=new ai(ed(12.94,7.4399999999999995,.36,.16),new uo({color:`#080d0f`,metalness:.04,roughness:.98}));T.position.set(.03,-.07,-.58),_.add(T);let E=rd(13.08,7.4799999999999995,.39,.43,qu);_.add(E);let D=rd(13.215,7.614999999999999,.42,-.415,qu);D.material.opacity=.42,_.add(D);let O=rd(12.719999999999999,7.119999999999999,.3,.44,new q(`#35515d`));O.material.opacity=.38,_.add(O);let k=new _i({color:`#263842`,transparent:!0,opacity:.38});[{x:-4.85,y:2.75,w:1,h:.45},{x:4.95,y:-2.8,w:1.05,h:.45},{x:-.2,y:3.1,w:2.2,h:.25}].forEach(({x:e,y:t,w:n,h:r})=>{let i=[new G(e-n/2,t-r/2,.455),new G(e+n/2,t-r/2,.455),new G(e+n/2,t+r/2,.455),new G(e-n/2,t+r/2,.455)];_.add(new Ei(new Ir().setFromPoints(i),k))});let ee=new Pi(.035,.035,.018,12);ee.rotateX(Math.PI/2);let A=new uo({color:`#26363c`,metalness:.08,roughness:.92});[[-5.45,2.72],[-5.18,2.72],[-4.91,2.72],[-5.45,2.48],[-5.18,2.48],[5.45,-2.62],[5.18,-2.62],[4.91,-2.62],[5.45,-2.86],[5.18,-2.86],[-5.75,-2.65],[-5.52,-2.82],[5.72,2.72],[5.48,2.88]].forEach(([e,t])=>{let n=new ai(ee,A);n.position.set(e,t,.47),_.add(n)});let te=new Vo(`#e0e7e8`,1.85);d.add(te);let j=new jo(`#d6e2e4`,`#06090b`,.55);d.add(j);let ne=[],M=[],N=new Map,P=[],re=[],ie=new eo(new Wi([new G(-6.05,-2.05,.54),...Hu.flatMap((e,t)=>{let[n,r,i]=e.position;return t===0?[new G(n-.65,r-.5,i),new G(n,r,i)]:[new G(n-.7,r-.18,i),new G(n,r,i)]})],!1,`centripetal`,.1),220,.019,8,!1),ae=new Float32Array(ie.attributes.position.count*3),oe=ie.attributes.position,se=Hu.at(-2).position[0],F=Hu.at(-1).position[0],I=new q;for(let e=0;e<oe.count;e+=1){let t=Ft.smoothstep(oe.getX(e),se,F);I.copy(qu).lerp(Ju,t).multiplyScalar(1.35),I.toArray(ae,e*3)}ie.setAttribute(`color`,new xr(ae,3));let ce=new ai(ie,new qr({color:`#ffffff`,vertexColors:!0,toneMapped:!1}));ce.castShadow=!1,_.add(ce),P.push(ie);let le=ie.index?.count??0;l.matches||ie.setDrawRange(0,0);let ue=new $a(.22,.018,8,48),de=new Pi(.055,.055,.035,24);de.rotateX(Math.PI/2),Hu.forEach(e=>{let t=e.current?Ju:qu,r=new uo({color:t,emissive:t,emissiveIntensity:e.current?1.35:1.15,metalness:0,roughness:.82,toneMapped:!1}),i=new Pn;i.position.fromArray(e.position),i.userData.id=e.id,i.userData.kind=`milestone`,i.userData.baseEmissive=e.current?1.35:1.15;let a=new ai(ue,r),o=new ai(de,r);o.position.z=.015,i.add(a,o);let s=new ai(new Ni(.35,24),new qr({transparent:!0,opacity:0,depthWrite:!1}));s.position.z=.03,s.userData.id=e.id,s.userData.kind=`milestone`,i.add(s),_.add(i),M.push({id:e.id,mesh:i,baseScale:1,materials:[r]});let c=new Nn;c.position.set(e.position[0],e.position[1]+.52,e.position[2]+.03),_.add(c),N.set(e.id,c);let l=sd(n,`milestone`,e.id,e.year,e.role,e=>u.current(e));e.current&&l.classList.add(`is-current`),ne.push({element:l,anchor:c,priority:2,width:132,height:62})});let fe=ed(1.28,1.12,.16,.025,.012,.018),pe=od(),me=[];Uu.forEach((e,t)=>{let r=Hu.find(({id:t})=>t===e.milestoneId),i=cd(e.category),a=new q(i),o=new G(...r.position),s=new G(e.position[0],e.position[1],.54),c=s.clone().sub(o),d=[o.clone().add(new G(0,-.18,-.015)),o.clone().add(c.clone().multiplyScalar(.32)).add(new G(.05,-.18,-.015)),o.clone().add(c.clone().multiplyScalar(.68)).add(new G(-.08,.08,-.015)),s.clone().add(new G(0,.65,-.015))],f=new Ir().setFromPoints(d),p=new ho({color:a,dashSize:.075,gapSize:.06,transparent:!0,opacity:l.matches?.8:0,toneMapped:!1}),m=new Ti(f,p);m.computeLineDistances(),_.add(m),re.push(p);let h=new Pn;h.position.set(e.position[0],e.position[1],.56),h.userData.id=e.id,h.userData.kind=`skill`;let g=new uo({color:`#050a0d`,emissive:`#010304`,emissiveIntensity:.04,metalness:0,roughness:1}),v=new ai(fe,g);v.userData.id=e.id,v.userData.kind=`skill`;let y=new ai(new Qa(1.55,1.38),new qr({map:pe,transparent:!0,opacity:.72,depthWrite:!1,toneMapped:!1}));y.position.set(.045,-.055,-.075);let b=id(1.21,1.05,.14,.045,a),x=b.material,S=ad(e.mark,e.name,i);me.push(S);let C=new qr({map:S,transparent:!0,toneMapped:!0}),w=new ai(new Qa(.96,.96),C);w.position.set(0,0,.05),h.add(y,v,b,w),_.add(h),M.push({id:e.id,mesh:h,baseScale:1,materials:[],accentMaterials:[x]});let T=new Nn;T.position.set(e.position[0],e.position[1],.63),_.add(T),N.set(e.id,T);let E=sd(n,`skill`,e.id,``,e.name,e=>u.current(e));ne.push({element:E,anchor:T,priority:1,width:1,height:1}),m.userData.revealDelay=.3+t*.08});let he=Zu.x,ge=Zu.y,_e=Zu.z,ve=0,ye=0,be=14.7,xe=null,Se=-1,Ce=!1,we=0,Te=new Map,Ee=new ss,De=new W;function Oe(e,n){let r=t.getBoundingClientRect();De.set((e-r.left)/r.width*2-1,-((n-r.top)/r.height)*2+1)}function ke(e,t){return Oe(e,t),Ee.setFromCamera(De,f),Ee.intersectObjects(M.map(({mesh:e})=>e),!0).find(e=>e.object.userData.id)?.object.userData.id}function Ae(e){if(t.setPointerCapture(e.pointerId),Te.set(e.pointerId,{x:e.clientX,y:e.clientY}),Ce=!1,Te.size===2){let[e,t]=[...Te.values()];we=Math.hypot(e.x-t.x,e.y-t.y)}t.classList.add(`is-grabbing`)}function je(e){let n=Te.get(e.pointerId);if(!n){let n=ke(e.clientX,e.clientY);xe=n??null,t.classList.toggle(`is-hovering`,!!n);return}let r=e.clientX-n.x,i=e.clientY-n.y;if(Te.set(e.pointerId,{x:e.clientX,y:e.clientY}),Math.abs(r)+Math.abs(i)>2&&(Ce=!0),Te.size===2){let[e,t]=[...Te.values()],n=Math.hypot(e.x-t.x,e.y-t.y);we&&(be=Ft.clamp(be-(n-we)*.018,10.2,19)),we=n;return}ye=r*$u,ve=i*$u,ge=Ft.clamp(ge+ye,Qu.minY,Qu.maxY),he=Ft.clamp(he+ve,Qu.minX,Qu.maxX)}function L(e){let n=Te.size===1;if(Te.delete(e.pointerId),Te.size||t.classList.remove(`is-grabbing`),n&&!Ce){let t=ke(e.clientX,e.clientY);t&&u.current(t)}we=0}function Me(e){e.preventDefault(),be=Ft.clamp(be+e.deltaY*.008,10.2,19)}function Ne(e){Se=(e+M.length)%M.length;let t=M[Se];ne.find(({element:e})=>e.dataset.id===t.id)?.element.focus({preventScroll:!0}),xe=t.id}function Pe(e){e.key===`ArrowRight`||e.key===`ArrowDown`?(e.preventDefault(),Ne(Se+1)):e.key===`ArrowLeft`||e.key===`ArrowUp`?(e.preventDefault(),Ne(Se-1)):(e.key===`Enter`||e.key===` `)&&Se>=0?(e.preventDefault(),u.current(M[Se].id)):e.key===`Escape`&&u.current(null)}o.current=()=>{he=Zu.x,ge=Zu.y,_e=Zu.z,be=14.7,ve=0,ye=0},s.current=()=>{t.focus({preventScroll:!0}),Ne(0)},t.addEventListener(`pointerdown`,Ae),t.addEventListener(`pointermove`,je),t.addEventListener(`pointerup`,L),t.addEventListener(`pointercancel`,L),t.addEventListener(`wheel`,Me,{passive:!1}),e.addEventListener(`keydown`,Pe);let R=new G,Fe=new G,z=new G,B=new G,Ie=new It,Le=new G(0,0,1),Re=1,ze=1;function Be(){let t=e.getBoundingClientRect();Re=Math.max(1,t.width),ze=Math.max(1,t.height),p.setPixelRatio(Math.min(window.devicePixelRatio,Re<720?1.35:1.8)),p.setSize(Re,ze,!1),m.setSize(Re,ze),g.resolution.set(Re,ze),f.aspect=Re/ze,f.updateProjectionMatrix()}let Ve=new ResizeObserver(Be);Ve.observe(e),Be();function He(){_.getWorldQuaternion(Ie),R.copy(Le).applyQuaternion(Ie);let e=[];ne.slice().sort((e,t)=>t.priority-e.priority).forEach(t=>{t.anchor.getWorldPosition(B),Fe.copy(f.position).sub(B).normalize(),z.copy(B).project(f);let n=(z.x*.5+.5)*Re,r=(-z.y*.5+.5)*ze,i=z.z>-1&&z.z<1&&z.x>-1.1&&z.x<1.1&&z.y>-1.1&&z.y<1.1&&R.dot(Fe)>.05,a={left:n-t.width/2,right:n+t.width/2,top:r-t.height/2,bottom:r+t.height/2},o=e.some(e=>!(a.right<e.left||a.left>e.right||a.bottom<e.top||a.top>e.bottom));t.element.style.transform=`translate3d(${n}px, ${r}px, 0) translate(-50%, -50%)`,t.element.classList.toggle(`is-hidden`,!i||o),t.element.classList.toggle(`is-selected`,t.element.dataset.id===c.current),i&&!o&&e.push(a)})}let Ue=new us,We=0;function Ge(){let e=Math.min(Ue.getDelta(),.05),t=Ue.elapsedTime,n=!l.matches;if(!Te.size&&n&&(ge=Ft.clamp(ge+ye,Qu.minY,Qu.maxY),he=Ft.clamp(he+ve,Qu.minX,Qu.maxX),ve*=.92,ye*=.92),_.rotation.x=Ft.lerp(_.rotation.x,he,.1),_.rotation.y=Ft.lerp(_.rotation.y,ge,.1),_.rotation.z=Ft.lerp(_.rotation.z,_e,.1),_.position.y=-.05+(n?Math.sin(t*.42)*.035:0),f.position.z=Ft.lerp(f.position.z,be,.12),n){let e=Ft.clamp(t/2.4,0,1);ie.setDrawRange(0,Math.floor(le*e)),re.forEach((e,n)=>{e.opacity=Ft.clamp((t-1.55-n*.08)*1.4,0,.82)})}M.forEach(e=>{let t=e.id===xe||e.id===c.current,r=e.baseScale*(t?1.09:1);e.mesh.scale.lerp(new G(r,r,r),n?.13:1),e.materials.forEach(r=>{if(`emissiveIntensity`in r){let i=r,a=e.mesh.userData.baseEmissive??1.15;i.emissiveIntensity=Ft.lerp(i.emissiveIntensity,t?a+.4:a,n?.12:1)}}),e.accentMaterials?.forEach(e=>{e.opacity=Ft.lerp(e.opacity,t?1:.78,n?.14:1)})}),He(),m.render(e),We=requestAnimationFrame(Ge)}return Ge(),()=>{cancelAnimationFrame(We),Ve.disconnect(),t.removeEventListener(`pointerdown`,Ae),t.removeEventListener(`pointermove`,je),t.removeEventListener(`pointerup`,L),t.removeEventListener(`pointercancel`,L),t.removeEventListener(`wheel`,Me),e.removeEventListener(`keydown`,Pe),ne.forEach(({element:e})=>e.remove()),v.dispose(),y.dispose(),b.dispose(),pe.dispose(),me.forEach(e=>e.dispose()),d.traverse(e=>{(e instanceof ai||e instanceof Ti||e instanceof Ei)&&(e.geometry.dispose(),(Array.isArray(e.material)?e.material:[e.material]).forEach(e=>e.dispose()))}),m.dispose(),p.dispose(),o.current=()=>void 0,s.current=()=>void 0}},[]),(0,$.jsxs)(`div`,{ref:r,className:`resume-scene`,children:[(0,$.jsx)(`canvas`,{ref:i,className:`resume-canvas`,tabIndex:0,"aria-label":`Interactive circuit board resume. Use arrow keys to move between nodes and Enter to open details.`}),(0,$.jsx)(`div`,{ref:a,className:`scene-labels`})]})});Gu();function ud(){return(0,$.jsx)(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`,children:(0,$.jsx)(`path`,{d:`M5 12h13M13 6l6 6-6 6`})})}function dd(){return(0,$.jsxs)(`svg`,{viewBox:`0 0 28 42`,"aria-hidden":`true`,children:[(0,$.jsx)(`rect`,{x:`2`,y:`2`,width:`24`,height:`38`,rx:`12`}),(0,$.jsx)(`path`,{d:`M14 8v8`})]})}function fd(){return(0,$.jsx)(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`,children:(0,$.jsx)(`path`,{d:`M12 2.6a9.6 9.6 0 0 0-3 18.7c.5.1.7-.2.7-.5v-1.9c-2.9.6-3.5-1.2-3.5-1.2-.5-1.2-1.2-1.5-1.2-1.5-1-.7.1-.7.1-.7 1.1.1 1.7 1.1 1.7 1.1 1 1.7 2.6 1.2 3.2.9.1-.7.4-1.2.7-1.5-2.3-.3-4.7-1.2-4.7-4.8 0-1.1.4-1.9 1-2.6-.1-.3-.4-1.3.1-2.6 0 0 .8-.3 2.7 1a9.3 9.3 0 0 1 4.9 0c1.9-1.3 2.7-1 2.7-1 .5 1.3.2 2.3.1 2.6.6.7 1 1.5 1 2.6 0 3.7-2.4 4.5-4.7 4.8.4.3.7 1 .7 1.9v2.8c0 .3.2.6.7.5A9.6 9.6 0 0 0 12 2.6Z`})})}function pd(){return(0,$.jsxs)(`a`,{className:`github-pulse`,href:Wu.profileUrl,target:`_blank`,rel:`noreferrer`,"aria-label":`View ${Wu.handle}'s GitHub contributions`,children:[(0,$.jsxs)(`span`,{className:`pulse-heading`,children:[(0,$.jsx)(`span`,{className:`pulse-icon`,children:(0,$.jsx)(fd,{})}),(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`strong`,{children:`GitHub pulse`}),(0,$.jsx)(`small`,{children:Wu.handle})]}),(0,$.jsx)(`span`,{className:`pulse-live`,children:`Live`})]}),(0,$.jsxs)(`span`,{className:`pulse-visual`,"aria-hidden":`true`,children:[(0,$.jsx)(`span`,{className:`contribution-grid`,children:Wu.activity.map((e,t)=>(0,$.jsx)(`span`,{className:`contribution-cell`,"data-level":Math.min(4,Math.ceil(e/2))},`${t}-${e}`))}),(0,$.jsx)(`svg`,{className:`pulse-wave`,viewBox:`0 0 224 44`,preserveAspectRatio:`none`,children:(0,$.jsx)(`path`,{d:`M1 26h51l8-1 7-11 9 25 10-36 10 23h26l7-4 7 7 8-3h79`})})]}),(0,$.jsxs)(`span`,{className:`pulse-stats`,children:[(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`strong`,{children:Wu.totalContributions}),` contributions`]}),(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`strong`,{children:Wu.currentStreak}),` day streak`]}),(0,$.jsx)(ud,{})]})]})}function md(){let e=(0,l.useRef)(null),[t,n]=(0,l.useState)(null),[r,i]=(0,l.useState)(!1);function a(e){if(!e){n(null);return}n(Hu.find(t=>t.id===e)??Uu.find(t=>t.id===e)??null)}return(0,$.jsxs)(`div`,{className:`app-shell`,children:[(0,$.jsxs)(`header`,{className:`site-header`,children:[(0,$.jsxs)(`a`,{className:`brand`,href:`#home`,"aria-label":`${Bu.name}, home`,children:[(0,$.jsx)(`span`,{className:`brand-mark`,children:Bu.initials}),(0,$.jsx)(`span`,{className:`brand-name`,children:Bu.name}),(0,$.jsx)(`span`,{className:`brand-role`,children:Bu.title})]}),(0,$.jsxs)(`button`,{className:`menu-toggle`,type:`button`,"aria-expanded":r,"aria-controls":`site-navigation`,onClick:()=>i(e=>!e),children:[(0,$.jsx)(`span`,{}),(0,$.jsx)(`span`,{}),(0,$.jsx)(`span`,{}),(0,$.jsx)(`span`,{className:`sr-only`,children:`Toggle navigation`})]}),(0,$.jsx)(`nav`,{id:`site-navigation`,className:r?`site-nav is-open`:`site-nav`,children:Vu.map((e,t)=>(0,$.jsx)(`a`,{className:t===0?`is-active`:void 0,href:e.href,onClick:()=>i(!1),children:e.label},e.label))}),(0,$.jsxs)(`a`,{className:`work-link`,href:`#projects`,children:[`View my work `,(0,$.jsx)(ud,{})]})]}),(0,$.jsxs)(`main`,{id:`home`,className:`hero`,children:[(0,$.jsxs)(`section`,{className:`hero-copy`,"aria-labelledby":`hero-title`,children:[(0,$.jsx)(`p`,{className:`eyebrow`,children:Bu.eyebrow}),(0,$.jsxs)(`h1`,{id:`hero-title`,children:[(0,$.jsxs)(`span`,{children:[Bu.headlinePrefix,` `,(0,$.jsx)(`em`,{children:Bu.headlineLead})]}),(0,$.jsx)(`strong`,{children:Bu.headlineAccent})]}),(0,$.jsx)(`span`,{className:`title-rule`,"aria-hidden":`true`}),(0,$.jsx)(`p`,{className:`introduction`,children:Bu.introduction}),(0,$.jsxs)(`button`,{className:`explore-button`,type:`button`,onClick:()=>e.current?.focusFirst(),children:[`Explore my journey`,` `,(0,$.jsx)(`span`,{children:(0,$.jsx)(ud,{})})]}),(0,$.jsx)(pd,{})]}),(0,$.jsxs)(`section`,{className:`scene-region`,"aria-label":`Interactive career circuit board`,children:[(0,$.jsx)(ld,{ref:e,selectedId:t?.id??null,onSelect:a}),(0,$.jsxs)(`div`,{className:`interaction-hint`,"aria-hidden":`true`,children:[(0,$.jsx)(dd,{}),(0,$.jsxs)(`p`,{children:[(0,$.jsx)(`span`,{children:`Drag to rotate`}),(0,$.jsx)(`span`,{children:`Scroll to zoom`})]})]}),(0,$.jsx)(`button`,{className:`reset-view`,type:`button`,onClick:()=>e.current?.resetView(),children:`Reset view`}),(0,$.jsxs)(`div`,{className:`path-legend`,"aria-label":`Circuit path legend`,children:[(0,$.jsxs)(`p`,{children:[(0,$.jsx)(`span`,{className:`legend-line career`}),`Career path`]}),(0,$.jsxs)(`p`,{children:[(0,$.jsx)(`span`,{className:`legend-line skill`}),`Skill path`]})]})]}),(0,$.jsx)(`aside`,{className:t?`detail-panel is-visible`:`detail-panel`,"aria-live":`polite`,"aria-hidden":!t,children:t&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`button`,{className:`detail-close`,type:`button`,onClick:()=>a(null),children:[(0,$.jsx)(`span`,{"aria-hidden":`true`,children:`x`}),(0,$.jsx)(`span`,{className:`sr-only`,children:`Close details`})]}),(0,$.jsx)(`p`,{className:`detail-kicker`,children:`year`in t?t.year:t.category}),(0,$.jsx)(`h2`,{children:`role`in t?t.role:t.name}),(0,$.jsx)(`p`,{className:`detail-meta`,children:`company`in t?t.company:t.level}),(0,$.jsx)(`p`,{children:t.summary})]})})]}),(0,$.jsx)(`div`,{className:`vignette`,"aria-hidden":`true`})]})}(0,u.createRoot)(document.getElementById(`root`)).render((0,$.jsx)(l.StrictMode,{children:(0,$.jsx)(md,{})}));